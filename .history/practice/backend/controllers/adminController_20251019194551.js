          ...
          <div class="content">
            ...
            <div class="security-section">
              ...
              <ul class="security-list">
                ...
                <li class="security-item">Ensure you are accessing the official Learning Resource Center portal</li>
                <li class="security-item">Contact system administrator if you did not initiate this request</li>
              </ul>
            </div>
          </div>
...
- Contact system administrator if you did not initiate this request
