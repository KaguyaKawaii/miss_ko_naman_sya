...
// 📌 Get user-specific notifications (STRICT VERSION)
exports.getUserNotifications = async (req, res) => {
  try {
    const { userId } = req.params;
    const { filter } = req.query;

    // ✅ FIXED: Only show notifications specifically for THIS user
    let query = { 
      userId: userId // Only notifications with THIS user's ID
    };
...
// 📌 Get unread count for a user (STRICT VERSION)
exports.getUnreadCount = async (req, res) => {
  try {
    ...
    // ✅ FIXED: Only count notifications specifically for THIS user
