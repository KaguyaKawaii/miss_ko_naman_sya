...
exports.resolveReport = async (req, res) => {
  try {
    ...
    // Get resolver info for logging - FIXED: Properly handle user lookup
...
exports.updateReportStatus = async (req, res) => {
  try {
    ...
    // Get updater info for logging - FIXED: Properly handle user lookup
...
exports.archiveReport = async (req, res) => {
  try {
    ...
    // Get archiver info for logging - FIXED: Properly handle user lookup
...
exports.restoreReport = async (req, res) => {
  try {
    ...
    // Get restorer info for logging - FIXED: Properly handle user lookup
...
exports.deleteArchivedReport = async (req, res) => {
  try {
    ...
    // Get deleter info for logging - FIXED: Properly handle user lookup
...
exports.assignReport = async (req, res) => {
  try {
    ...
    // Get assigner and staff info for logging - FIXED: Properly handle user lookup
