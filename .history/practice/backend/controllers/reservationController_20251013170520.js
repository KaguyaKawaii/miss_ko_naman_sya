...
exports.validateFloorAccess = async (req, res) => {
  try {
    ...
    // ✅ FIXED: Process each participant with better error handling
    for (const participantId of validParticipantIds) {
      try {
        console.log('🔍 Looking up participant:', participantId);
        
        // ✅ FIXED: Better participant lookup with proper field selection
        ...
        // ✅ FIXED: Check if participant is verified
