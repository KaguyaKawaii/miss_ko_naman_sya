...
exports.removeParticipant = async (req, res) => {
  try {
    ...
    console.log('➖ Removing participant from reservation:', { id, id_number });
    ...
    if (participantUser) {
      try {
        ...
        console.warn("⚠️ Failed to create notification for removed participant:", notifError.message);
      }
      ...
      try {
        ...
        console.warn("⚠️ Failed to send email to removed participant:", emailError.message);
      }
    }
