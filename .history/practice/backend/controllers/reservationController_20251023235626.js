...
exports.getParticipantsDetails = async (req, res) => {
  try {
    // ✅ FIXED: Handle both parameter names from different routes
    ...
    console.log('✅ Found reservation, processing participants...');
    ...
    console.log('✅ Successfully fetched participants details');
    res.json(response);
  } catch (err) {
