...
/* ------------------------------------------------
   ✅ GET PARTICIPANTS DETAILS (FIXED)
------------------------------------------------ */
exports.getParticipantsDetails = async (req, res) => {
  try {
    // ✅ FIXED: Use the correct parameter name based on your route
    const { id } = req.params; // If your route is /:id/participants
    // OR
    // const { reservationId } = req.params; // If your route is /:reservationId/participants
    ...
    console.log('✅ Found participants:', participantsDetails.length);
