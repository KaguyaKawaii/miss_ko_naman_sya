...
// Configure Cloudinary (make sure this is in your server.js or here)
cloudinary.config({
...
exports.uploadPicture = async (req, res) => {
  try {
    ...
    console.log("Uploading profile picture for user:", req.params.id);
    ...
    // Check if we have a file buffer (from multer)
    if (!req.file.buffer) {
    ...
    // Configure Cloudinary (make sure this is in your server.js or config)
    cloudinary.config({
      cloud_name: process.env.CLOUDINARY_CLOUD_NAME,
      api_key: process.env.CLOUDINARY_API_KEY,
      api_secret: process.env.CLOUDINARY_API_SECRET
