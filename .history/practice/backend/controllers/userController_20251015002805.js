    ...
    if (io) {
      try {
        ...
        const notification = new Notification({
          ...
          type: "system", // ✅ Valid type from your enum
          status: verifyStatus ? "Verified" : "Unverified", // ✅ Use the status field instead
          isRead: false,
          targetRole: "user",
          userName: user.name,
        ...
        console.log(`✅ Verification notification sent to user ${user._id}`);
      } catch (notifyError) {
