...
// 📌 Report workflow
router.put("/start/:id", reportController.startReport);        // Staff starts working on report
...
router.put("/toggle-verify/:id", userController.toggleVerifyUser); // ✅ ADD THIS MISSING ROUTE
