...
// ✅ ADDED: Participants details routes - MUST COME BEFORE :id ROUTE
router.get('/participants/details/:reservationId', reservationController.getParticipantsDetails);
router.get('/:id/participants', reservationController.getParticipantsDetails); // MOVED UP

// ✅ MOVED: Single reservation by ID route AFTER specific routes
router.get('/:id', reservationController.getReservationById); // This should be LAST
