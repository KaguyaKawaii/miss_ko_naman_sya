...
// services/reservationService.js - Add this function
exports.expirePastReservations = async () => {
  try {
    const now = new Date();
    console.log(`🔄 Running expirePastReservations service at: ${now}`);
    ...
    console.log(`✅ Service expired ${result.modifiedCount} reservations`);
    return result.modifiedCount;
  } catch (error) {
    console.error("❌ Error in expirePastReservations service:", error);
    throw error;
  }
};