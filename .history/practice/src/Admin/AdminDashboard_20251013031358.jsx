...
function AdminDashboard({ setView }) {
  ...
  const quickActions = [
    { id: "adminReservation", label: "Reservations", icon: "📅" },
    { id: "adminUsers", label: "Users", icon: "👥" },
    { id: "adminRoom", label: "Rooms", icon: "🏠" },
    { id: "adminMessage", label: "Messages", icon: "💬" },
    { id: "adminNews", label: "News", icon: "📢" },
    { id: "adminReports", label: "Reports", icon: "⚠️" },
    { id: "adminNotifications", label: "Notifications", icon: "🔔" }
  ];
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm border border-gray-200/60 hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm font-medium">Room Status</p>
            ...
            <div className="mt-4 pt-3 border-t border-gray-200/60">
              <p className="text-xs text-gray-500">
                <span className="font-medium text-gray-700">{summaryData.availableRooms}</span> available,{" "}
                <span className="font-medium text-gray-700">{summaryData.occupiedRooms}</span> occupied
              </p>
            </div>
          </div>
                ...
                {quickActions.map((action) => (
                  ...
                  >
                    <div className="text-left flex-1">
                      ...
                      <p className="text-sm font-medium text-gray-700 group-hover:text-blue-700 inline">{action.label}</p>
                    </div>
