      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2 space-y-8">
            ...
            {/* Room Availability Section - Added from StaffDashboard */}
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-semibold text-gray-800">
                  Room Availability - All Floors
                </h2>
              ...
              {rooms.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-400">No rooms are currently available in the system.</p>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {rooms.map(room => {
                            ...
                            <div className="space-y-2">
                              {bookings.map((booking, index) => (
                                <div key={index} className="flex justify-between items-center text-xs">
                                  ...
                                  <span className="text-gray-500 flex ml-2 max-w-[180px]">
                                    {booking.user}
                                  </span>
