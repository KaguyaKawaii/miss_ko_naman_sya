            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 rounded-lg bg-green-50 border border-green-200">
                  ...
                  <span className="text-sm text-green-700 bg-green-100 px-3 py-1 rounded-lg font-medium">Online</span>
                </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-green-50 border border-green-200">
                  ...
                  <span className="text-sm text-green-700 bg-green-100 px-3 py-1 rounded-lg font-medium">Connected</span>
                </div>
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-green-50 border border-green-200">
                  ...
                  <span className="text-sm text-green-700 bg-green-100 px-3 py-1 rounded-lg font-medium">Active</span>
                </div>
              </div>
            </div>
          </div>
