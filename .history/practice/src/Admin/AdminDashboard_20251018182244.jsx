...
function AdminDashboard({ setView }) {
  ...
  const quickActions = [
    { id: "adminReservation", icon: <CalendarIcon size={20} />, label: "Reservations" },
    { id: "adminUsers", icon: <Users size={20} />, label: "Users" },
    { id: "adminRoom", icon: <Home size={20} />, label: "Rooms" },
    { id: "adminMessage", icon: <MessageSquare size={20} />, label: "Messages" },
    { id: "adminNews", icon: <FileText size={20} />, label: "News" },
    { id: "adminReports", icon: <AlertCircle size={20} />, label: "Reports" },
    { id: "adminNotifications", icon: <Bell size={20} />, label: "Notifications" },
    { id: "adminSettings", icon: <Settings size={20} />, label: "Settings" }
  ];
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'booked': return 'text-red-700 bg-red-50 border-red-200';
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {quickActions.map((action) => (
                  <button
                    ...
                    className="flex flex-col items-center p-4 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 transition-all duration-200 hover:shadow-md"
                  >
                    <div className="p-3 rounded-xl bg-gray-100 border mb-3 shadow-sm text-gray-600">
                      {action.icon}
                    </div>
              ...
              <div className="bg-white p-6 rounded-xl border border-amber-200 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-800 text-sm font-semibold">From Users</span>
                      <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded-lg text-sm font-bold">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-800 text-sm font-semibold">From Staff</span>
                      <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded-lg text-sm font-bold">
              ...
              {newsList.length === 0 ? (
                ...
                <div className="space-y-4">
                  ...
                  {newsList.length > 3 && (
                    <button 
                      onClick={() => setCurrentSubView("news")}
                      className="w-full py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg transition-colors duration-200 border border-gray-200"
                    >
          ...
          <div className="space-y-6">
              ...
              {recentActivity.length === 0 ? (
                ...
                <div className="space-y-4">
                  {recentActivity.map((activity) => (
                    <div key={activity.id} className="flex items-start space-x-4 p-4 rounded-lg border border-gray-200 hover:shadow-sm transition-shadow duration-200">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 rounded-lg border border-gray-200 bg-gray-50">
                ...
                <div className="flex justify-between items-center p-4 rounded-lg border border-gray-200 bg-gray-50">
                  <span className="text-sm font-medium text-gray-800">Last Data Sync</span>
