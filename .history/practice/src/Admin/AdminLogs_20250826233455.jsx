...
function AdminLogs({ setView }) {
  ...
  const exportCSV = () => {
    ...
    const rows = filteredLogs.map((log) => [
      log.userName || "System",
      log.id_number || "—", // ✅ fixed field name
      log.action,
      log.details || "—",
  ...
  return (
    <>
      ...
      <main className="ml-[250px] w-[calc(100%-250px)] min-h-screen bg-gray-50">
        {/* ✅ Header with filters */}
        <header className="bg-white px-6 py-4 border-b border-gray-200 flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
          ...
          <div className="flex flex-wrap items-center gap-3 mt-4 md:mt-0">
            <div className="relative">
              <input
                ...
                className="border rounded-lg pl-10 pr-3 py-2 text-sm w-full md:w-64 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            ...
            {/* Date Range Selector with Calendar Dropdown */}
            <div className="relative">
              <button
                onClick={() => setShowCalendar(!showCalendar)}
                className="border rounded-lg px-4 py-2 text-sm flex items-center gap-2 bg-white hover:bg-gray-50 transition-colors"
              >
            ...
            <button
              ...
              className="bg-gray-100 hover:bg-gray-200 px-4 py-2 rounded-lg text-sm transition-colors flex items-center gap-1"
            >
              {sortOrder === "desc" ? (
                <>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg text-sm transition-colors flex items-center gap-1"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* ✅ Logs container with scrollable area */}
        <div className="p-6">
          {loading ? (
