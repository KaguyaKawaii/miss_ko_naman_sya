            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 flex-1">
                ...
                <div className="relative flex-1 max-w-md">
                  ...
                  <input
                    ...
                    className="border border-gray-300 rounded-lg pl-10 pr-4 py-2.5 text-sm w-full focus:ring-2 focus:ring-[#CC0000] focus:border-[#CC0000] outline-none transition-all"
                  />
                </div>
                ...
                <div className="relative">
                  <button
                    ...
                    className="border border-gray-300 rounded-lg px-4 py-2.5 text-sm flex items-center gap-2 bg-white hover:bg-gray-50 transition-colors focus:ring-2 focus:ring-[#CC0000] focus:border-[#CC0000] outline-none"
                  >
                ...
                <button
                  ...
                  className="bg-gray-100 hover:bg-gray-200 px-4 py-2.5 rounded-lg text-sm transition-colors flex items-center gap-2 focus:ring-2 focus:ring-[#CC0000] focus:border-[#CC0000] outline-none border border-transparent"
                >
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={exportCSV}
                    className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm transition-colors flex items-center gap-2 focus:ring-2 focus:ring-green-500 outline-none"
                  >
                    <svg className="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <button
                    onClick={exportPDF}
                    className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm transition-colors flex items-center gap-2 focus:ring-2 focus:ring-blue-500 outline-none"
                  >
                    <svg className="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                ...
                <button
                  ...
                  className="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg text-sm transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed focus:ring-2 focus:ring-gray-500 outline-none"
                >
                  <svg className="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {loading ? (
              ...
              <div className="p-12 text-center">
                ...
                {getActiveFilterCount() > 0 && (
                  <button
                    onClick={clearFilters}
                    className="mt-4 bg-[#CC0000] text-white px-4 py-2 rounded-lg text-sm hover:bg-red-700 transition-colors"
                  >
                    Clear All Filters
                  </button>
                )}
              ...
              <div className="bg-gray-900 text-gray-300">
                <div className="max-h-[65vh] overflow-y-auto p-4">
                  <div className="space-y-3">
                    {filteredLogs.map((log) => (
                      <div key={log._id} className="flex items-start gap-4 hover:bg-gray-800 px-4 py-3 rounded-lg transition-colors">
                        <div className="text-gray-500 text-xs w-24 flex-shrink-0 mt-0.5">
                          {new Date(log.createdAt).toLocaleTimeString("en-PH", {
                            hour: '2-digit',
                            minute: '2-digit',
                            second: '2-digit'
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-1">
                            ...
                            <span className="text-green-400 text-sm bg-green-900 bg-opacity-50 px-2 py-0.5 rounded">
                              {log.action}
                            </span>
                          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md border border-gray-200">
              ...
              <div className="grid grid-cols-1 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#CC0000] focus:border-[#CC0000] outline-none transition-all"
                  />
                </div>
                <div>
            ...
            <div className="flex gap-3 p-6 border-t border-gray-200 bg-gray-50 rounded-b-2xl">
              ...
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-[#CC0000] text-white rounded-lg hover:bg-red-700 transition-colors font-medium"
              >
                Apply Filter
              </button>
            </div>
