              ...
              <div className="bg-gray-900 text-gray-300">
                <div className="max-h-[65vh] overflow-y-auto p-4">
                  <div className="space-y-2">
                    {filteredLogs.map((log) => (
                      <div key={log._id} className="flex items-center justify-items-center gap-6 hover:bg-gray-800 px-4 py-3 rounded-lg transition-colors">
                        {/* Time */}
                        ...
                        <div className="flex items-center gap-2 min-w-[120px]">
                          ...
                          <span className="text-blue-400 font-medium text-sm truncate">
                            {log.userName || "System"}
                          </span>
                        </div>
                        ...
                        <div className="min-w-[120px]">
                          <span className="inline-flex px-2 py-1 rounded text-xs font-medium bg-green-900 bg-opacity-50 text-green-400">
                            {log.action}
                          </span>
                        </div>
                        ...
                        {/* Full Date */}
                        <div className="text-gray-500 text-xs min-w-[100px] text-right flex-shrink-0">
                          {new Date(log.createdAt).toLocaleDateString("en-PH")}
                        </div>
                      </div>
                    ))}
