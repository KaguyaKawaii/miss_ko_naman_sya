...
function AdminNavigation({ admin, setView, currentView, onLogout }) {
  ...
  const navButtons = [
    ...
    { 
      ...
      label: "Activity Logs", 
      icon: ListOrdered,
      svg: <svg xmlns="http://www.w3.org2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3.01" y2="6"></line><line x1="3" y1="12" x2="3.01" y2="12"></line><line x1="3" y1="18" x2="3.01" y2="18"></line></svg>
    },
  ];
  ...
  return (
    <aside>
      <div className="fixed top-0 left-0 h-screen w-[250px] bg-[#030303] p-0 flex flex-col border-r border-gray-800">
        {/* Logo + Title */}
        ...
        <div className="flex flex-col h-full overflow-y-auto bg-[#030303]">
          <div className="flex flex-col flex-grow">
            {navButtons.map(({ id, label, icon: Icon, svg }) => (
              <button
                ...
                onClick={() => setView(id)}
                className={`w-full flex items-center gap-3 px-4 py-3 text-left transition-all duration-200 focus:outline-none border-l-4 ${
                  currentView === id
            ...
            <div>
              <button
                ...
                className={`w-full flex items-center justify-between px-4 py-3 text-left transition-all duration-200 focus:outline-none border-l-4 ${
              ...
              {archiveOpen && (
                <div className="flex flex-col bg-[#0a0a0a] border-l-2 border-gray-800 ml-2">
                  {archiveOptions.map(({ id, label, svg }) => (
                    <button
                      key={id}
                      ref={(el) => (navRefs.current[id] = el)}
                      onClick={() => setView(id)}
                      className={`w-full flex items-center gap-2 px-4 py-2 text-sm rounded transition-all duration-200 mx-2 my-1 ${
                        currentView === id
          ...
          <div className="mt-auto border-t border-gray-800 bg-[#0a0a0a]">
            <button
              onClick={onLogout}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm text-gray-400 hover:bg-red-900/20 hover:text-red-300 transition-all duration-200 hover:border-l-4 hover:border-red-500"
            >
