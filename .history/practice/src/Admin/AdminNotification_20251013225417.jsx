...
function AdminNotification({ setView }) {
  ...
  const transformReservationData = (reservation) => {
    ...
    return {
      ...reservation,
      roomName: reservation.roomName || reservation.roomId?.roomName || "Unknown Room",
      location: reservation.location || reservation.roomId?.location || "Unknown Location",
      userId: reservation.userId || reservation.user || { name: "Unknown User" },
      datetime: reservation.datetime || reservation.startDatetime,
      ...
      extensionStatus: reservation.extensionStatus,
  ...
  // Handle action success from modals
  ...
  const filteredNotifications = notifications.filter(notification => {
    ...
    if (activeFilter === "reservations") return notification.type === "reservation";
    return true;
  });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <AdminNavigation setView={setView} />
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <div className="flex flex-wrap gap-2">
            {["all", "unread", "reports", "reservations"].map((filter) => (
              <button
                key={filter}
          ...
          <button
            ...
            className="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 text-sm font-medium"
          >
            Mark All as Read
          </button>
        </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button className="text-blue-600 hover:text-blue-800 font-medium text-sm transition-colors duration-200 flex items-center gap-1">
