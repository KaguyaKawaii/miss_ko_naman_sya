            ...
            {loading ? (
              ...
              <div className="divide-y divide-gray-100">
                {filteredNotifications.map((notification) => {
                  ...
                  const reservationStatus = getReservationStatusInfo(notification);
                  const totalParticipants = getTotalParticipants(notification);
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {/* Additional context */}
                          {(notification.reservationId || notification.userId) && (
                            <div className="mt-2 flex flex-wrap gap-1">
                              {notification.reservationId && (
                                <span className="text-xs bg-gray-100 text-gray-700 px-2 py-0.5 rounded">
                                  Room: {notification.reservationId.roomName || "Unknown"}
                                </span>
                              )}
                              {notification.userId && (
                                <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded">
                                  User: {notification.userId.name || "Unknown User"}
                                </span>
                              )}
                              {notification.type === "reservation" && totalParticipants > 0 && (
