  ...
  const fetchReports = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        } else if (res.data.success && Array.isArray(res.data.reports)) {
          // Case 2: { success: true, reports: [...] }
          reportsData = res.data.reports;
        } else if (res.data.success && Array.isArray(res.data.users)) {
          // Case 3: { success: true, users: [...] } - This seems to be your case
          reportsData = res.data.users;
