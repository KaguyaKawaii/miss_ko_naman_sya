...
const fetchReports = () => {
  ...
  axios
    ...
    .then((res) => {
      ...
      // Temporary: try to extract data in different ways
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 outline-0 focus:border-blue-500"
                />
                {search && (
                  <button
                    onClick={() => setSearch("")}
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-5">
                        ...
                        <div className="space-y-4">
                          ...
                          <button
                            ...
                            className="px-4 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-medium text-sm flex items-center gap-2 cursor-pointer"
                          >
                            <CheckCircle size={16} />
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-5">
                        ...
                        <div className="space-y-4">
                          <textarea
                            ...
                            className="w-full h-32 p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 outline-0 focus:border-transparent resize-none"
                            disabled={actionLoading}
                          />
                          
                          <div className="flex items-center gap-2 text-sm text-gray-600">
                            <AlertCircle size={16} />
                            Required to resolve the report
                          </div>
                        </div>
                      </div>
                    )}
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-5">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center justify-between py-2">
                            ...
                            <span className="font-semibold text-gray-900">
                              {report.assignedAt ? formatPHDateTime(report.assignedAt) : "N/A"}
                            </span>
                          </div>
                        </div>
                      </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 border border-gray-200">
            ...
            <div className="flex gap-3 justify-end mt-6">
              <button
                ...
                disabled={actionLoading}
                className="px-4 py-2.5 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-all duration-200 font-medium text-sm disabled:opacity-50 cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                disabled={actionLoading}
                className={`px-4 py-2.5 text-white rounded-lg transition-all duration-200 font-medium text-sm flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer ${confirmConfig.confirmColor}`}
              >
                {actionLoading ? (
                  <>
