...
function AdminReports({ setView }) {
  ...
  const handleArchiveConfirm = async () => {
    ...
    try {
      ...
      await axios.put(`http://localhost:5000/api/reports/${report._id}/archive`, {
                          ...
                          <div className="flex justify-end space-x-2">
                            ...
                            {report.status !== "Archived" && (
                              <button
                                ...
                                className="p-1.5 text-gray-600 hover:text-gray-800 rounded cursor-pointer"
        ...
        <div className="fixed inset-0 backdrop-blur-sm bg-black/30 flex items-center justify-center z-50 transition-all duration-300">
          <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4 transform transition-all duration-300 scale-100">
            ...
            <p className="text-gray-600 mb-6">
              Are you sure you want to archive the report "{archiveConfirmModal.report?.category}"? This action cannot be undone.
            </p>
