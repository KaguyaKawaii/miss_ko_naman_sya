            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:outline-red-600 outline-1 "
                />
                {search && (
                  <button
                    onClick={() => setSearch("")}
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none pl-4 pr-8 py-2 border outline-0 border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 cursor-pointer"
                >
