            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none pl-4 pr-8 py-2 border outline-0 border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:focus:outline-red-600 cursor-pointer"
                >
