...
function AdminRooms({ setView }) {
  ...
  // Available room images for selection
        ...
        {floors.map((floor) => (
          <button
            ...
            className={`px-4 py-3 rounded-xl border transition-all duration-300 font-medium text-sm ${
              selectedFloor === floor
                ? "bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-md border-blue-600"
            ...
            <div className="space-y-3">
              {roomImage ? (
                ...
                <button
                  ...
                  className="w-full p-6 border-2 border-dashed border-gray-300 rounded-xl hover:border-blue-400 hover:bg-blue-50/50 transition-all duration-200 flex flex-col items-center justify-center gap-2"
                >
