      ...
      <main className="ml-[250px] w-[calc(100%-250px)] min-h-screen bg-white">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-6">
            {/* Total Users */}
            <StatCard label="Total Users" value={userStats.total} icon={<Users size={20} />} color="gray" />
            <StatCard label="Students" value={userStats.students} icon={<GraduationCap size={20} />} color="gray" />
            <StatCard label="Faculty" value={userStats.faculty} icon={<UserCog size={20} />} color="gray" />
            <StatCard label="Staff" value={userStats.staff} icon={<UserCheck size={20} />} color="gray" />
            <StatCard label="Verified" value={userStats.verified} icon={<UserCheck size={20} />} color="gray" />
            <StatCard label="Unverified" value={userStats.unverified} icon={<UserX size={20} />} color="gray" />
            <StatCard label="Suspended" value={userStats.suspended} icon={<UserX size={20} />} color="gray" />
            <StatCard label="Active" value={userStats.active} icon={<UserCheck size={20} />} color="gray" />
          </div>
...
function StatCard({ label, value, icon, color }) {
  const colorClasses = {
    blue: "bg-gray-50 text-gray-800 border-gray-200",
    green: "bg-gray-50 text-gray-800 border-gray-200",
    purple: "bg-gray-50 text-gray-800 border-gray-200",
    yellow: "bg-gray-50 text-gray-800 border-gray-200",
    red: "bg-gray-50 text-gray-800 border-gray-200",
