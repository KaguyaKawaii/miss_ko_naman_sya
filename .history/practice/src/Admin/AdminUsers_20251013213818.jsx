...
function AdminUsers({ setView }) {
  ...
  return (
    <>
      ...
      <main className="ml-[250px] w-[calc(100%-250px)] min-h-screen bg-white">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-6">
            {/* Total Users */}
            <StatCard label="Total Users" value={userStats.total} icon={<Users className="text-blue-600" size={20} />} />
            <StatCard label="Students" value={userStats.students} icon={<GraduationCap className="text-green-600" size={20} />} />
            <StatCard label="Faculty" value={userStats.faculty} icon={<UserCog className="text-purple-600" size={20} />} />
            <StatCard label="Staff" value={userStats.staff} icon={<UserCheck className="text-yellow-600" size={20} />} />
            <StatCard label="Verified" value={userStats.verified} icon={<UserCheck className="text-green-600" size={20} />} />
            <StatCard label="Unverified" value={userStats.unverified} icon={<UserX className="text-red-600" size={20} />} />
            <StatCard label="Suspended" value={userStats.suspended} icon={<UserX className="text-red-600" size={20} />} />
            <StatCard label="Active" value={userStats.active} icon={<UserCheck className="text-green-600" size={20} />} />
          </div>
...
function StatCard({ label, value, icon }) {
  return (
    <div className="bg-white p-5 rounded-2xl shadow-sm border-2 border-gray-200 transition-all duration-300 hover:shadow-md hover:scale-105">
