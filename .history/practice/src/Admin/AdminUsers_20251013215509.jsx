...
<div className="flex flex-col gap-4 mb-6 w-full">
  ...
  <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
    <h2 className="text-lg font-semibold text-gray-800 mb-4">User Statistics Overview</h2>
    
    {/* Role Statistics - Flex Layout */}
    <div className="flex flex-wrap gap-4 mb-4">
      {/* Total Users */}
      <div className="flex-1 min-w-[200px] bg-blue-50 p-4 rounded-lg border border-blue-100">
      ...
      {/* Students */}
      <div className="flex-1 min-w-[200px] bg-green-50 p-4 rounded-lg border border-green-100">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-green-600 font-medium">Students</p>
            <p className="text-2xl font-bold text-green-700">{userStats.students}</p>
          </div>
      ...
      {/* Faculty */}
      <div className="flex-1 min-w-[200px] bg-purple-50 p-4 rounded-lg border border-purple-100">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-purple-600 font-medium">Faculty</p>
            <p className="text-2xl font-bold text-purple-700">{userStats.faculty}</p>
          </div>
      ...
      {/* Staff */}
      <div className="flex-1 min-w-[200px] bg-yellow-50 p-4 rounded-lg border border-yellow-100">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-yellow-600 font-medium">Staff</p>
            <p className="text-2xl font-bold text-yellow-700">{userStats.staff}</p>
          </div>
      ...
      {/* Staff Office */}
      <div className="flex-1 min-w-[200px] bg-indigo-50 p-4 rounded-lg border border-indigo-100">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-indigo-600 font-medium">Staff Office</p>
            <p className="text-2xl font-bold text-indigo-700">{userStats.staffOffice}</p>
          </div>
    ...
    <div className="flex flex-wrap gap-4">
      ...
      <div className="flex-1 min-w-[200px] bg-green-50 p-4 rounded-lg border border-green-100">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-green-700">{userStats.verified}</p>
          </div>
          <div className="bg-green-100 p-2 rounded-full">
      ...
      {/* Unverified */}
      <div className="flex-1 min-w-[200px] bg-red-50 p-4 rounded-lg border border-red-100">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-red-600 font-medium">Unverified</p>
            <p className="text-2xl font-bold text-red-700">{userStats.unverified}</p>
          </div>
      ...
      <div className="flex-1 min-w-[200px] bg-red-50 p-4 rounded-lg border border-red-100">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-red-700">{userStats.suspended}</p>
          </div>
          <div className="bg-red-100 p-2 rounded-full">
            <UserX className="text-red-600" size={20} />
          </div>
      ...
      <div className="flex-1 min-w-[200px] bg-green-50 p-4 rounded-lg border border-green-100">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-green-700">{userStats.active}</p>
          </div>
          <div className="bg-green-100 p-2 rounded-full">
            <UserCheck className="text-green-600" size={20} />
          </div>
