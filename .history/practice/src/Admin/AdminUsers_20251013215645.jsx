...
<div className="flex flex-col gap-4 mb-6 w-full">
  ...
  <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
    ...
    <div className="flex flex-wrap gap-4">
      {/* Total Users */}
      <div className="flex-1 min-w-[200px] bg-blue-50 p-4 rounded-lg border border-blue-200">
      ...
      {/* Students */}
      <div className="flex-1 min-w-[200px] bg-green-50 p-4 rounded-lg border border-green-200">
        <div className="flex items-center justify-between">
          <div>
      ...
      {/* Faculty */}
      <div className="flex-1 min-w-[200px] bg-purple-50 p-4 rounded-lg border border-purple-200">
        <div className="flex items-center justify-between">
          <div>
      ...
      {/* Staff */}
      <div className="flex-1 min-w-[200px] bg-yellow-50 p-4 rounded-lg border border-yellow-200">
        <div className="flex items-center justify-between">
          <div>
      ...
      {/* Staff Office */}
      <div className="flex-1 min-w-[200px] bg-indigo-50 p-4 rounded-lg border border-indigo-200">
        <div className="flex items-center justify-between">
          <div>
  ...
  <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
    ...
    <div className="flex flex-wrap gap-4">
      ...
      {/* Unverified */}
      <div className="flex-1 min-w-[200px] bg-red-50 p-4 rounded-lg border border-red-200">
        <div className="flex items-center justify-between">
          <div>
      ...
      {/* Suspended */}
      <div className="flex-1 min-w-[200px] bg-orange-50 p-4 rounded-lg border border-orange-200">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm text-orange-600 font-medium">Suspended</p>
            <p className="text-2xl font-bold text-orange-700">{userStats.suspended}</p>
          </div>
      ...
      <div className="flex-1 min-w-[200px] bg-blue-50 p-4 rounded-lg border border-blue-200">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-blue-700">{userStats.active}</p>
          </div>
          <div className="bg-blue-100 p-2 rounded-full">
