...
const fetchArchivedReports = async () => {
  try {
    setLoading(true);
const res = await axios.get("http://localhost:5000/api/reports/archived");
...
// In ArchivedReports.jsx - replace the handleRestore function:
  ...
  const handleRestore = async (id) => {
    try {
      const currentUserId = "684d3500778bcd5a0469ca76";
...
const handleDelete = async (id) => {
  try {
    const currentUserId = "684d3500778bcd5a0469ca76"; // Replace this with actual user ID from your auth context
