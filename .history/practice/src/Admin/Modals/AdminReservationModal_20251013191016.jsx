...
const AdminReservationModal = ({ 
  ...
  // Calculate user counts - including main reserver as participant
  const participantCount = reservation.participants?.length || 0;
  const totalParticipants = participantCount + 1; // +1 for main reserver
        ...
        <div>
          ...
          <div className="flex items-center gap-3 text-sm text-gray-600 mt-1">
            <div className="flex items-center gap-1">
              <IdCard size={12} />
              <span>{participant.idNumber || participant.id_number}</span>
            </div>
            <div className="flex items-center gap-1">
              <Building size={12} />
  ...
  // Create participants array including main reserver
  const allParticipants = [
    {
      name: reservation.userId?.name,
      idNumber: reservation.userId?.id_number,
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <InfoCard
                  ...
                  icon={<Users size={20} />}
                  subtitle={`${allParticipants.length} people`}
                />
                <InfoCard
                  title="Start Time"
                ...
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{totalParticipants} total members</p>
                    </div>
                  </div>
