      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-2">
            ...
            {isMainReserver && (
              <span className="px-2 py-0.5 bg-purple-100 text-purple-800 text-xs rounded-full font-medium flex-shrink-0">
                Main
              </span>
            )}
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 text-xs text-gray-600">
            ...
            {(participant.year_level && participant.year_level !== "N/A") && (
              <div className="flex items-center gap-1">
                ...
                <span className="truncate">Year {participant.year_level}</span>
              </div>
            )}
          </div>
        </div>
            ...
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                ...
                <div className="space-y-3">
                  ...
                  {/* Show message if there are more than 4 participants in the original data */}
                  {(reservation.participants?.length || 0) > 3 && (
                    <div className="text-center py-4 text-gray-500 text-sm bg-gray-50 rounded-lg border border-gray-200">
                      <p>
                        + {(reservation.participants?.length || 0) - 3} more participants not shown
                      </p>
                    </div>
                  )}
                </div>
