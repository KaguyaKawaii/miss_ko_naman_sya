...
const AdminReservationModal = ({ 
  ...
  // Create participants array including main reserver + all additional participants
  const mainReserver = {
  ...
  // Get ALL additional participants (not limited to 3)
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <InfoCard
                  ...
                  icon={<Users size={20} />}
                  subtitle={`${totalParticipants} people total`}
                />
                <InfoCard
                  title="Start Time"
