  ...
  useEffect(() => {
    const fetchStaff = async () => {
      try {
        ...
        // Try the main users endpoint - it should return all users
        ...
        try {
          ...
          const altRes = await axios.get("http://localhost:5000/users");
          console.log("Alternative endpoint response:", altRes.data);
          
          let altStaffData = [];
          if (Array.isArray(altRes.data)) {
            altStaffData = altRes.data.filter(user => user.role === "Staff");
          }
