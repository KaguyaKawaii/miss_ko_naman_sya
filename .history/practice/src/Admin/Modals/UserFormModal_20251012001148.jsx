  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        course: form.role === "Student" || form.role === "Staff_Office" ? form.course || "N/A" : "N/A",
        ...
        <div className="p-6">
          {isView ? (
            <div className="space-y-4">
              ...
              {user.role === "Staff" ? (
                ...
                <>
                  ...
                  {(user.role === "Student" || user.role === "Staff_Office") && (
                    <>
                      <DetailItem 
                        icon={<GraduationCap size={16} />} 
                        label={user.role === "Staff_Office" ? "Position" : "Program"} 
                        value={user.course} 
                      />
                    </>
                  )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Program/Position for Student & Staff_Office */}
              {(form.role === "Student" || form.role === "Staff_Office") && form.department && (
                <div className="space-y-1">
                  <label className="text-sm font-medium text-gray-700">
                    {form.role === "Staff_Office" ? "Position" : "Program"}
                  </label>
                  {form.role === "Student" ? (
                    <select
                      value={form.course}
                    ...
                    <input
                      ...
                      value={form.course}
                      onChange={(e) => handleChange("course", e.target.value)}
                      placeholder="Enter position (e.g., Administrative Assistant)"
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500"
                      required
                    />
                  )}
