    ...
    <div className="ml-[250px] w-[calc(100%-250px)] min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Left Column - Maintenance & Announcements */}
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      className="sr-only peer outline-0 cursor-pointer"
                    />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="3"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#CC0000] focus:border-transparent transition-colors outline-0 cursor-pointer"
                  />
                </div>
          ...
          {/* Right Column - Backup Management */}
          <div className="space-y-6">
            ...
            <div className="flex justify-end">
              <button
                ...
                disabled={isLoading}
                className="flex items-center gap-2 px-8 py-4 bg-[#CC0000] text-white rounded-lg hover:bg-red-700 focus:ring-2 focus:ring-[#CC0000] focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer outline-0 text-lg font-semibold w-full justify-center"
              >
                <Save size={20} />
                {isLoading ? 'Saving System Settings...' : 'Save All System Settings'}
              </button>
            </div>
          </div>
        </div>
