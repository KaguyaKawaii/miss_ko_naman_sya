  ...
  return (
    <div className="ml-[250px] w-[calc(100%-250px)] min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        ...
        {/* Maintenance Warning for Admin */}
        {showMaintenanceWarning && (
          <div className="max-w-6xl mx-auto mb-6 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            {formData.maintenanceMode && (
              <div className="mt-6 bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  <Wrench size={18} className="text-[#CC0000] mt-0.5" />
                  <div>
                    <h4 className="text-sm font-medium text-red-800">Maintenance Mode Information</h4>
                    <p className="text-sm text-red-700 mt-1">
        ...
        <div className="max-w-6xl mx-auto mb-6">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold text-gray-800 flex items-center gap-2">
                <Megaphone size={20} className="text-[#CC0000]" />
                System Announcement
              </h2>
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 text-sm bg-red-100 text-[#CC0000] rounded-lg hover:bg-red-200 transition-colors cursor-pointer outline-0"
                >
            ...
            <div className="space-y-6">
                        ...
                        <div key={announcement._id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 flex-wrap">
                              ...
                              <span className="text-xs text-[#CC0000] bg-red-100 px-2 py-1 rounded">
                    ...
                    <div className="lg:col-span-3 grid grid-cols-1 lg:grid-cols-3 gap-4">
                      ...
                      <div className="lg:col-span-2 flex items-end">
                        <button
                          ...
                          className="flex items-center gap-2 px-6 py-3 bg-[#CC0000] text-white rounded-lg hover:bg-red-700 focus:ring-2 focus:ring-[#CC0000] focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer outline-0 w-full justify-center"
                        >
                          <Megaphone size={18} />
              ...
              {formData.announcementEnabled && (
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    <Megaphone size={18} className="text-[#CC0000] mt-0.5" />
                    <div>
                      <h4 className="text-sm font-medium text-red-800">Announcement Information</h4>
                      <p className="text-sm text-red-700 mt-1">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-3 bg-[#CC0000] text-white rounded-lg hover:bg-red-700 focus:ring-2 focus:ring-[#CC0000] focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer outline-0"
                    >
                      {isCreatingBackup ? (
                        <>
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    Create a compressed ZIP backup with all database collections
                  </p>
                </div>
              </div>
                        ...
                        <div key={backup.id || backup.name} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 flex-wrap">
                              <span className="font-medium text-sm text-gray-900 flex items-center gap-2">
                                <Archive size={14} className="text-[#CC0000]" />
                                {backup.name}
                              </span>
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className="flex items-center gap-1 px-3 py-2 text-[#CC0000] hover:bg-red-50 rounded-lg transition-colors cursor-pointer outline-0"
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex justify-end">
              <button
                ...
                disabled={isLoading}
                className="flex items-center gap-2 px-8 py-3 bg-[#CC0000] text-white rounded-lg hover:bg-red-700 focus:ring-2 focus:ring-[#CC0000] focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer outline-0"
              >
                <Save size={18} />
