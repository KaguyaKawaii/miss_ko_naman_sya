          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            {isLoadingBackups ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {backups.map((backup) => (
                  <div key={backup.id || backup.name} className="border border-gray-200 rounded-lg p-4 w-[10rem] bg-gray-50 hover:bg-gray-100 transition-colors">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <span className="text-xs text-gray-500 bg-white px-3 py-1 rounded">
                        {backup.size}
                      </span>
                    </div>
