...
function App() {
  ...
  <div class="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full mx-auto">
    <div class="text-center space-y-6">
      ...
      <div class="space-y-2">
        <h2 class="text-2xl font-bold text-gray-800">Loading Content</h2>
        <p class="text-gray-600">Please wait while we prepare your experience</p>
      </div>
      
      <div class="space-y-3">
        <div class="w-full bg-gray-200 rounded-full h-2.5 overflow-hidden">
          <div class="h-full bg-gradient-to-r from-blue-500 to-purple-600 rounded-full relative animate-loading">
