...
function App() {
  ...
  const renderUserNavigation = (Component) => (
    <div className="min-h-screen bg-gray-50">
      ...
      />
      <main className="w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        {Component}
      </main>
    </div>
  );
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex items-center justify-center p-4">
        <div className="text-center space-y-6 max-w-sm w-full">
          ...
          <div className="flex justify-center">
            <div className="w-16 h-16 bg-gradient-to-br from-[#CC0000] to-[#B30000] rounded-2xl flex items-center justify-center shadow-lg">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
            <div className="h-full bg-[#CC0000] rounded-full animate-pulse"></div>
          </div>
    ...
    <div className="min-h-screen bg-white">
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="w-full max-w-sm rounded-xl bg-white shadow-2xl px-6 py-8 relative">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="flex-1 px-5 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 cursor-pointer transition-colors duration-200"
              >
                No, stay
              </button>
              <button
                onClick={handleLogout}
                className="flex-1 px-5 py-2 bg-[#CC0000] text-white rounded-lg hover:bg-red-600 cursor-pointer transition-colors duration-200"
              >
                Yes, log out
              </button>
            </div>
