...
useEffect(() => {
  if (maintenanceMode && isMaintenanceChecked) {
    ...
    // SPECIAL CASE: Always allow admin login page during maintenance
    if (view === 'adminLogin') {
      console.log("Allowing access to admin login during maintenance");
      return; // Don't redirect, allow access to admin login
    }
