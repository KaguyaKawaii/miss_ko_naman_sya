...
useEffect(() => {
  if (maintenanceMode && isMaintenanceChecked) {
    ...
    // SPECIAL CASE: Always allow admin login page for everyone
    if (view === 'adminLogin') {
      console.log("Allowing access to admin login page for everyone");
      return;
    }
    ...
    if (user && user.role === 'admin' && !allowAdminAccess) {
      setView("maintenance");
      return;
    }
