...
useEffect(() => {
  ...
  if (path && path !== location.pathname) {
    ...
    // ALWAYS ALLOW: Admin login and admin users during maintenance
    if (view === 'adminLogin' || user?.role === 'admin') {
      console.log("Allowing navigation for admin login or admin user");
      navigate(path, { replace: false });
      return;
    }
    ...
    if (maintenanceMode && view !== 'maintenance') {
      console.log("Blocking navigation for non-admin during maintenance");
      return;
    }
