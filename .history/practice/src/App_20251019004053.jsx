...
useEffect(() => {
  ...
  if (maintenanceMode) {
    ...
    // CRITICAL: Always allow admin login page for everyone - NO REDIRECTS
    if (view === 'adminLogin') {
    ...
    // For non-admin users, only redirect to maintenance if they're trying to access other pages
    if (view !== 'maintenance' && user?.role !== 'admin') {
