...
const isViewAllowed = () => {
  ...
  // Always allow adminLogin and home pages during maintenance - anyone can access these
  if (view === 'adminLogin' || view === 'home') return true;
...
useEffect(() => {
  if (maintenanceMode && isMaintenanceChecked) {
    ...
    // CRITICAL: Always allow access to adminLogin and home pages during maintenance
    // Anyone should be able to access admin login from maintenance screen
    if (view === 'adminLogin' || view === 'home') {
      console.log("Allowing access to admin login and home pages during maintenance");
      return;
    }
