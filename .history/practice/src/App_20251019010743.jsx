...
const handleMaintenanceRedirect = (maintenanceData) => {
  ...
  // CRITICAL: Always allow adminLogin and home pages - anyone can access these
  if (view === 'adminLogin' || view === 'home') {
    console.log("Allowing access to admin login and home pages during maintenance");
    return;
  }
...
const isViewAllowed = () => {
  ...
  // Always allow adminLogin page during maintenance
  if (view === 'adminLogin') return true;
  
  return (isAdmin && allowAdminAccess) || isStaff || view === 'maintenance';
};
