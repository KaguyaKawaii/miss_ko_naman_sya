...
const handleAdminLoginSuccess = (adminData) => {
  ...
  // After admin login, check if they should be redirected to maintenance or dashboard
  if (maintenanceMode) {
    const isAdmin = adminData.role === 'admin';
    const isStaff = adminData.role === 'staff';
    const isAllowedUser = (isAdmin && allowAdminAccess) || isStaff;
...
return (
  <div>
    ...
    {/* Allow adminLogin even during maintenance */}
    {view === "adminLogin" && (
      <Login_Admin
