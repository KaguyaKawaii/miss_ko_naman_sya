...
const slides = [
  ...
  { src: GroundFloor, label: "Ground Floor Overview", description: "Main library area with various study spaces and resources", category: "overview" },
];
...
const categories = [
  ...
  { id: "overview", name: "Overview", color: "from-purple-500 to-purple-600" },
];
    ...
    <section className="relative min-h-screen bg-gradient-to-b from-gray-50 to-white text-gray-800 py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden flex flex-col items-center">
      ...
      <div className="text-center mb-8 sm:mb-12 lg:mb-16 max-w-4xl mx-auto transform transition-all duration-500">
        ...
        <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-4">
          Explore our thoughtfully designed spaces that foster productivity, collaboration, and academic excellence across all floors
        </p>
      </div>
      ...
      <div className="w-full max-w-6xl xl:max-w-7xl mx-auto">
        ...
        {/* Room Statistics */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 lg:gap-6 mt-6 sm:mt-8 lg:mt-10 max-w-6xl mx-auto">
          {categories.map((category) => (
            <div 
              key={category.id}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-[#CC0000] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <span className="text-white text-sm font-bold">G</span>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900 text-lg">Ground Floor</h4>
                  <p className="text-gray-600 text-sm">Main entrance, reception area, general study spaces, and overview of library facilities</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 text-lg">First Floor</h4>
                  <p className="text-gray-600 text-sm">Specialized rooms including Discussion Rooms, Graduate Research Hubs, Faculty Rooms, and Collaboration Spaces</p>
                </div>
              </div>
            </div>
            <div className="bg-gray-50 rounded-lg p-4 sm:p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-[#CC0000] rounded-full mr-3"></div>
                  Faculty Rooms - 2 rooms available
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-amber-500 rounded-full mr-3"></div>
                  Collaboration Rooms - 2 rooms available
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
                  Discussion Rooms - 3 rooms available
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
                  Graduate Research Hubs - 3 rooms available
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-purple-500 rounded-full mr-3"></div>
                  Overview Spaces - 1 area available
                </li>
              </ul>
            </div>
          </div>
