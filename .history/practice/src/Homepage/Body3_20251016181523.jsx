...
function Body3() {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 text-gray-800 py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden flex flex-col items-center">
      {/* Decorative elements */}
      <div className="absolute top-0 right-0 w-60 h-60 sm:w-80 sm:h-80 bg-[#CC0000]/5 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl -z-10"></div>
      <div className="absolute bottom-0 left-0 w-72 h-72 sm:w-96 sm:h-96 bg-[#CC0000]/5 rounded-full translate-y-1/2 -translate-x-1/2 blur-3xl -z-10"></div>
      <div className="absolute top-1/3 left-1/4 w-48 h-48 sm:w-64 sm:h-64 bg-[#CC0000]/5 rounded-full blur-3xl -z-10"></div>
      
      {/* Floor Header Section */}
      <div className="w-full max-w-7xl mx-auto mb-12 sm:mb-16 lg:mb-20 px-4">
        ...
        <div className="relative w-full h-64 sm:h-80 lg:h-96 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl mb-12 sm:mb-16">
          <img
      ...
      <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-5xl mx-auto px-4">
        ...
        <div className="w-20 sm:w-24 lg:w-32 h-1.5 bg-gradient-to-r from-[#CC0000] via-[#CC0000] to-[#CC0000] mx-auto rounded-full mb-6 sm:mb-8"></div>
            ...
            >
              <div className="text-center">
                ...
                <div className={`w-10 h-0.5 mx-auto rounded-full transition-all duration-300 ${
                  activeFloorIndex === floorIndex ? "bg-white/60" : "bg-[#CC0000]/30"
                }`}></div>
              </div>
            </button>
          ))}
      ...
      <div className="w-full max-w-7xl mx-auto px-4">
        ...
        >
          ...
          {allSlides.map((slide, i) => (
            ...
            >
              ...
              <div className="absolute top-4 sm:top-6 left-4 sm:left-6 z-20">
                <div className="bg-gradient-to-r from-[#CC0000] to-[#990000] text-white px-3 py-1 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-semibold shadow-xl backdrop-blur-sm">
                ...
                {allSlides.map((_, i) => (
                  <button
                    ...
                    className={`h-1.5 sm:h-2 rounded-full transition-all duration-300 ${
                      i === index 
                        ? "w-6 sm:w-8 lg:w-12 bg-[#CC0000] shadow-lg" 
          ...
          <div className="absolute bottom-4 sm:bottom-6 right-4 sm:right-6 flex items-center space-x-2 sm:space-x-3 bg-black/40 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1.5 sm:py-2 z-20 transition-opacity duration-300 shadow-xl">
            <button
              onClick={togglePlay}
              className="p-1 sm:p-2 text-white hover:text-[#CC0000] transition-colors duration-200"
          ...
          <button
            onClick={prev}
            className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-2 sm:p-3 bg-black/40 backdrop-blur-sm rounded-full text-white hover:text-[#CC0000] transition-all duration-300 opacity-0 group-hover:opacity-100 shadow-xl hover:bg-black/60"
          ...
          <button
            onClick={next}
            className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-2 sm:p-3 bg-black/40 backdrop-blur-sm rounded-full text-white hover:text-[#CC0000] transition-all duration-300 opacity-0 group-hover:opacity-100 shadow-xl hover:bg-black/60"
