  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-4xl lg:max-w-6xl mx-auto relative z-10">
        ...
        {/* Contact Section */}
        <div className="text-center mt-16 sm:mt-20 lg:mt-24 pt-8 sm:pt-12 border-t border-white/10">
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 mb-6 sm:mb-8">
            Still have questions?
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            <button className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-amber-400 to-amber-600 text-gray-900 font-semibold rounded-xl sm:rounded-2xl shadow-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-3xl overflow-hidden">
            ...
            <button className="group relative px-6 sm:px-8 py-3 sm:py-4 border-2 border-amber-400 text-amber-400 font-semibold rounded-xl sm:rounded-2xl transition-all duration-300 transform hover:scale-105 hover:bg-amber-400/10 overflow-hidden">
              <span className="relative z-10">Visit Help Center</span>
              <div className="absolute inset-0 bg-amber-400/5 transform -skew-x-12 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"></div>
            </button>
          </div>
        </div>
      </div>
