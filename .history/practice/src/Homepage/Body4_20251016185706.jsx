...
function Body4() {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="absolute top-0 left-0 w-72 h-72 sm:w-96 sm:h-96 bg-blue-400/5 rounded-full -translate-x-1/2 -translate-y-1/2 blur-3xl"></div>
      <div className="absolute bottom-0 right-0 w-80 h-80 sm:w-[30rem] sm:h-[30rem] bg-blue-600/5 rounded-full translate-x-1/2 translate-y-1/2 blur-3xl"></div>
      ...
      <div className="max-w-6xl lg:max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 sm:mb-20 lg:mb-24">
          <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-blue-500 to-blue-700 rounded-3xl shadow-xl mb-6 sm:mb-8 lg:mb-10">
          ...
          <div className="w-24 sm:w-32 lg:w-40 h-1.5 bg-gradient-to-r from-transparent via-blue-500 to-transparent mx-auto rounded-full mb-6 sm:mb-8"></div>
        ...
        <div className="space-y-6 sm:space-y-8">
          {faqSections.map((section, sectionIndex) => {
            ...
            return (
              <div
                key={sectionIndex}
                className="bg-white/80 backdrop-blur-sm border border-gray-200/60 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden"
              >
                {/* Section Header */}
                <button
                  onClick={() => toggleSection(sectionIndex)}
                  className="w-full px-6 sm:px-8 lg:px-10 py-6 sm:py-8 text-left flex items-center justify-between gap-4 sm:gap-6 transition-all duration-300 hover:bg-gray-50/50"
                >
                    ...
                    <div className="space-y-4">
                      {section.questions.map((faq, questionIndex) => {
                        ...
                        return (
                          <div
                            key={questionIndex}
                            className="bg-gray-50/50 rounded-xl border border-gray-200/60 overflow-hidden hover:bg-gray-100/50 transition-colors duration-300"
                          >
                            <button
                            ...
                            >
                              <h4 className="text-base sm:text-lg font-semibold text-gray-800 flex-1 min-w-0 leading-relaxed text-left">
                                {faq.question}
                              </h4>
        ...
        <div className="mt-16 sm:mt-20 text-center">
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl sm:rounded-3xl p-8 sm:p-12 text-white shadow-2xl">
