    ...
    <section className="relative min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="hidden lg:flex justify-center space-x-6 mb-12">
          {sections.map((section, index) => (
            <button
              key={section.title}
              onClick={() => setActiveSection(index)}
              className={`flex items-center space-x-3 px-6 py-4 rounded-xl font-semibold transition-all duration-300 backdrop-blur-sm border ${
                activeSection === index
                  ? `bg-gradient-to-r ${section.color} text-white shadow-lg transform scale-105 border-transparent`
                  : "bg-white/5 text-gray-300 shadow-md hover:shadow-lg hover:scale-105 border-white/10"
              }`}
            >
        ...
        <div className="text-center">
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl shadow-lg p-8 max-w-2xl mx-auto border border-white/10">
            ...
            <button
              ...
              className="group bg-gradient-to-r from-amber-400 to-amber-600 text-gray-900 px-8 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 inline-flex items-center space-x-2"
            >
