        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 mb-12 sm:mb-16 lg:mb-20">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-amber-400 to-amber-600 rounded-2xl flex items-center justify-center shadow-2xl">
                <span className="text-lg sm:text-xl font-bold text-gray-900">C</span>
              </div>
              <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-12">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-3 sm:space-y-4">
                {[
                  { name: "Room Reservations", href: "#" },
                  { name: "Facility Guide", href: "#" },
