      ...
      <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${
        ...
        {isOpen && (
          <div className="md:hidden fixed inset-0 z-50 overflow-hidden">
            ...
            <div 
              className={`absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 transition-transform duration-500 ease-in-out ${
                ...
                <div className="flex flex-col items-center space-y-12 mb-20">
                  {navigationItems.map((item, index) => (
                    <button
                      key={item.id}
                      onClick={() => scrollToSection(item.id)}
                      className="text-4xl font-bold text-white hover:text-amber-400 transition-all duration-500 transform hover:scale-110 cursor-pointer"
                      style={{
