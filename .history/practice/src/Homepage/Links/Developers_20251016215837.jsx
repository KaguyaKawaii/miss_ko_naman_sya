  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-red-900 to-gray-800 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Enhanced Member Detail Modal - WHITE THEME */}
        {activeMember && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            {/* Enhanced Modal Content - WHITE THEME */}
            <div className="relative bg-white rounded-2xl shadow-3xl w-full max-w-4xl max-h-[90vh] overflow-hidden border border-gray-200">
              <button
                onClick={() => setActiveMember(null)}
                className="absolute top-4 right-4 z-10 bg-white hover:bg-gray-100 text-gray-600 hover:text-gray-900 rounded-xl p-2 transition-all duration-300 shadow-lg hover:shadow-xl backdrop-blur-md hover:scale-110 border border-gray-200"
              >
                <X className="w-5 h-5" />
              </button>

              <div className="flex flex-col lg:flex-row">
                {/* Enhanced Left Side - Profile - WHITE THEME */}
                <div className="lg:w-2/5 bg-gradient-to-br from-red-500 to-red-600 p-6 text-white relative overflow-hidden">
                  {/* Background Pattern */}
                  ...
                  <div className="relative text-center lg:text-left">
                    ...
                    <div className="w-36 h-36 mx-auto lg:mx-0 mb-6 rounded-full bg-white p-2 shadow-2xl border-2 border-white/20">
                      <img
                    ...
                    <div className="flex items-center justify-center lg:justify-start gap-2 mb-4">
                      ...
                      <span className="font-bold text-red-100 text-base">{activeMember.role}</span>
                    </div>
                    
                    <p className="text-red-100 leading-relaxed text-sm mb-6 font-light">
                ...
                {/* Enhanced Right Side - Details - WHITE THEME */}
                <div className="lg:w-3/5 p-6 overflow-y-auto max-h-[70vh]">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
                    {activeMember.skills.map((skill, index) => (
                      <div
                        key={index}
                        className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-3 text-center border border-red-200 hover:border-red-400 hover:shadow-lg transition-all duration-300 group hover:scale-105"
                      >
                        <span className="font-bold text-red-700 text-sm group-hover:text-red-800 transition-colors duration-300">
                          {skill}
                        </span>
                      </div>
                    ))}
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-red-50 rounded-xl p-5 border border-gray-200 shadow-lg">
                    ...
                    <div className="space-y-3">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 bg-gray-800 hover:bg-gray-900 text-white px-4 py-3 rounded-xl transition-all duration-300 w-full group hover:shadow-lg hover:scale-105"
                      >
                        <Github className="w-5 h-5" />
                      ...
                      <a
                        href={`mailto:${activeMember.email}`}
                        className="flex items-center gap-3 bg-red-500 hover:bg-red-600 text-white px-4 py-3 rounded-xl transition-all duration-300 w-full group hover:shadow-lg hover:scale-105"
                      >
                        <Mail className="w-5 h-5" />
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 bg-red-600 hover:bg-red-700 text-white px-4 py-3 rounded-xl transition-all duration-300 w-full group hover:shadow-lg hover:scale-105"
                      >
                        <ExternalLink className="w-5 h-5" />
