  ...
  const teamMembers = [
    {
      ...
      bio: "With over 2 years of experience in web development, Stephen specializes in creating scalable applications using modern technologies. When not coding, he enjoys contributing to open-source projects and mentoring junior developers. His passion for clean code and efficient systems drives him to continuously learn and implement best practices in every project.",
      skills: ["React", "Node.js", "MongoDB", "Express", "TypeScript", "JavaScript", "Git", "REST APIs", "Jest", "Docker"],
      github: "https://github.com/patrickandrade",
      email: "patrick.andrade@usa.edu.ph",
      portfolio: "https://patrickandrade.dev",
      joinDate: "2022",
      location: "Iloilo City, Philippines",
      interests: ["Open Source", "Tech Blogs", "Hackathons", "Mentoring"],
      favoriteTech: "React & Node.js Ecosystem"
    },
    {
      id: 2,
                ...
                <div className="lg:w-3/5 p-8 overflow-y-auto max-h-[85vh]">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {activeMember.interests.map((interest, index) => (
                        <span
                          key={index}
                          className="bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 px-4 py-2 rounded-full text-sm font-medium border border-blue-200"
                        >
                          {interest}
                        </span>
                      ))}
