      ...
      <div className="max-w-lg w-full text-center space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="text-gray-600 space-y-3 text-lg leading-relaxed">
            ...
            <p className="text-sm text-gray-500">
              This scheduled maintenance includes security enhancements,
              performance optimizations, and new feature deployments to serve
              you better.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 bg-[#CC0000] text-white font-medium rounded-lg hover:bg-red-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            <RefreshCw size={18} />
            Refresh Status
          </button>
        ...
        <div className="text-xs text-gray-500 space-y-2 pt-6 border-t border-gray-200">
          <p>
            <strong>Impact:</strong> All user-facing services are temporarily
            unavailable
          </p>
          <p>
            <strong>Administrator note:</strong> System access restricted to
            authorized personnel only during maintenance window
          </p>
          <p className="pt-2">
            Thank you for your patience and understanding during this necessary
            maintenance period.
          </p>
        </div>
      </div>
