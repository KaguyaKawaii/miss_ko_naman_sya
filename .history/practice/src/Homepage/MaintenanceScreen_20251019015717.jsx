      ...
      <div className="max-w-lg w-full text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 bg-[#CC0000] text-white font-medium rounded-lg hover:bg-red-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
          >
            <RefreshCw size={18} />
            Refresh Status
          </button>
