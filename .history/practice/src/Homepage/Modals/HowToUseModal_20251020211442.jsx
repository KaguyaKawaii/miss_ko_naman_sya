      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-3xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6 text-gray-800">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-semibold text-lg">5. Add participants</h3>
              <p className="mt-1 text-sm">
                Add other users as participants by their university IDs or emails. Each group must have a minimum of 4 and a maximum of 8 users (including the main reserver). Participants can join the reservation but will be checked for time conflicts to prevent double-bookings.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-semibold text-lg">6. System validations</h3>
              <p className="mt-1 text-sm">
        ...
        <div className="sticky bottom-0 bg-gray-50 rounded-b-2xl p-4 border-t border-gray-200">
          <div className="flex justify-end">
            <button
              onClick={onClose}
              className="px-6 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors duration-200 font-medium cursor-pointer"
            >
              Got it, thanks!
            </button>
          </div>
