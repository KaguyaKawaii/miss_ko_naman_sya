...
function Login_Admin({ onAdminLoginSuccess, onBackToUserLogin }) {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-gray-900 rounded-2xl shadow-2xl overflow-hidden border border-gray-700 backdrop-blur-sm">
        {/* Header Section */}
        <div className="bg-gradient-to-r from-red-900 to-amber-900 p-6 text-white text-center">
          ...
          <h1 className="text-xl font-bold mb-2">University of San Agustin</h1>
          ...
          {requiresOTP ? (
            ...
            <form onSubmit={handleOTPVerification} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  className="w-full border border-gray-600 bg-gray-800 p-4 rounded-xl text-center text-2xl font-mono tracking-widest text-white placeholder-gray-500 focus:border-amber-500 transition-all duration-300 outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                  type="text"
                  placeholder="000000"
                  maxLength="6"
                  value={otp}
            ...
            <form onSubmit={handleAdminLogin} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  className="w-full border border-gray-600 bg-gray-800 p-4 rounded-xl text-white placeholder-gray-500 focus:border-amber-500 transition-all duration-300 outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                  type="text"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    className="w-full border border-gray-600 bg-gray-800 p-4 rounded-xl text-white placeholder-gray-500 focus:border-amber-500 transition-all duration-300 outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent pr-12"
