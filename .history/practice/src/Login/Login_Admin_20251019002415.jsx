...
const handleBackToUserLogin = () => {
  // Always allow going back to user login, regardless of maintenance mode
  // The maintenance screen will handle redirecting back to maintenance if needed
  onBackToUserLogin();
};
  ...
  className="px-6 py-3 rounded-lg bg-gray-700 hover:bg-gray-600 text-white border-gray-600 cursor-pointer transition-all duration-300"
>
  Back to User Login
</button>
          </div>
