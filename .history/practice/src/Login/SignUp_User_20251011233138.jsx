...
const handleSubmit = async (e) => {
  ...
  // For staff, check if department is required
  if (formData.role === "Staff_Office") {
    if (!formData.department) return setMessage("Please select a department");
    if (!formData.course) return setMessage("Position is required for staff");
  }
  ...
  try {
    ...
    const payload = {
      ...
      department: formData.role === "Student" || formData.role === "Staff_Office" ? formData.department : "N/A",
    };
          ...
          <div className="md:w-3/5 p-8">
            ...
            {!otpSent ? (
              ...
              >
                ...
                {/* Department - Show for Students and Staff */}
                {(formData.role === "Student" || formData.role === "Staff_Office") && (
                  <div className="flex flex-col gap-1">
                    <label className="text-sm font-medium text-gray-700">
                      {formData.role === "Staff_Office" ? "Office/Department" : "Department"}
                    </label>
                    <select
                      name="department"
                      ...
                      required
                    >
                      <option value="">Select {formData.role === "Staff_Office" ? "Office/Department" : "Department"}</option>
                ...
                {/* Program/Position - Show for Students and Staff */}
                {(formData.role === "Student" || formData.role === "Staff_Office") && formData.department && (
                  <div className="flex flex-col gap-1">
                    ...
                    <select
                      ...
                      required
                    >
                      <option value="">Select {formData.role === "Staff_Office" ? "Position" : "Program"}</option>
                ...
                {/* Year Level - Show only for Students (not for Staff) */}
