...
import { Eye, EyeOff, CheckCircle, Loader2, Search, X, ChevronDown, Home } from "lucide-react";
...
function SignUp_User({ onSwitchToLogin, setView }) {
  ...
  return (
    <main className=" min-h-dvh w-screen bg-white md:bg-gradient-to-br md:from-blue-50 md:via-white md:to-yellow-50 flex items-center justify-center p-0 m-0 overflow-x-hidden">
      ...
      <div className="fixed top-4 left-4 z-30">
        <button
          ...
          className="flex items-center gap-2 text-gray-600 hover:text-gray-800 font-medium cursor-pointer transition-colors duration-200 bg-white/80 backdrop-blur-sm px-3 py-2 rounded-lg"
        >
          <Home size={18} />
      ...
      {/* Main Content Container - Full screen on mobile */}
      <div className="w-full h-full bg-white md:bg-transparent overflow-y-auto">
        <div className="w-full h-full md:max-w-5xl md:mx-auto md:my-4 md:rounded-2xl md:shadow-2xl md:border md:border-gray-200 md:overflow-hidden md:flex">
          ...
          {/* Right side - Form Content - Full screen on mobile */}
          <div className="w-full h-full md:w-3/5 p-6 md:p-8 overflow-y-auto">
