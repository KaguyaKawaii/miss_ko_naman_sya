...
const ReservationModal = ({ 
  ...
  // Create participants array including main reserver + additional participants
  const mainReserver = {
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <InfoCard
                  ...
                  icon={<Users size={20} />}
                  subtitle={`${reservation.numUsers || totalParticipants} users`}
                />
                <InfoCard
                  title="Start Time"
                ...
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{totalParticipants} members</p>
                    </div>
                  </div>
