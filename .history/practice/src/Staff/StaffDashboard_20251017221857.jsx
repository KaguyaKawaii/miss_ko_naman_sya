...
function StaffDashboard({ staff, setView, unreadCounts, onRefreshCounts }) {
  ...
  const processFetchedData = (data) => {
    ...
    setSummaryData({
      ...
      users: totalRegularUsers, // Now only counts regular users (non-staff)
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            {/* Calendar - Integrated directly into dashboard */}
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              <h2 className="text-lg font-semibold text-gray-800 mb-4">
                Calendar
              </h2>
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="flex justify-between items-center">
                  <button 
                    ...
                    className="px-4 py-2 bg-red-500 hover:bg-red-600 text-white font-medium rounded-lg transition-colors duration-200 shadow-sm hover:shadow-md text-sm"
                  >
                    Select Today
                  </button>
