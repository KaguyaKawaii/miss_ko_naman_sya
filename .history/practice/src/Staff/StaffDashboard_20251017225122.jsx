...
// Use CORRECT API endpoints that match your backend
const endpoints = [
  { key: 'reservations', url: `/api/reservations` }, // ADD /api prefix
  { key: 'messages', url: `/api/messages/staff-total-unread/${staff._id}` }, // ADD /api prefix
  { key: 'notifications', url: `/api/notifications/unread-count/${staff._id}` }, // ADD /api prefix
  { key: 'users', url: '/api/users' }, // ADD /api prefix
