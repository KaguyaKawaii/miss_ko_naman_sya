            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-6">
                {activeTab === "calendar" ? (
                  ...
                  <div>
                    <h2 className="text-lg font-semibold text-gray-800 mb-4">
                      Room Availability - {selectedDate.toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })}
                    </h2>
                    
                    {rooms.length === 0 ? (
                      <div className="text-center py-8">
                        <Home className="mx-auto text-gray-400 mb-2" size={32} />
                        <p className="text-gray-500">No rooms found for {staff?.floor}.</p>
                      </div>
                    ) : (
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center">
                                ...
                                <div>
                                  <span className="text-sm font-medium text-gray-800 block">{room.room}</span>
                                  <span className="text-xs text-gray-500">{availability.message}</span>
                                </div>
                              </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      ...
                      <div className="grid grid-cols-1 gap-2 text-xs">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-gray-500">Room is free</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                          ...
                          <span className="text-gray-500">Reserved for today</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
