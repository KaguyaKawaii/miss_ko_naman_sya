...
function StaffNavigation({ staff, setView, currentView, onLogout }) {
  ...
  const handleLogoutClick = () => {
    console.log("=== StaffNavigation Logout Clicked ===");
    console.log("onLogout prop value:", onLogout);
    console.log("onLogout type:", typeof onLogout);
    
    if (onLogout && typeof onLogout === 'function') {
      console.log("✅ Calling onLogout function to show modal");
      onLogout();
    } else {
      console.error("❌ onLogout is not available:", onLogout);
      console.log("Available props:", { staff, setView, currentView, onLogout });
    }
  };
  ...
  return (
    <aside className="z-50">
      <div className="fixed top-0 left-0 h-screen w-[250px] bg-gray-900 p-6 flex flex-col border-r border-gray-700 z-50">
        {/* Logo */}
