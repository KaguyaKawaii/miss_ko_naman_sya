              ...
              <div className="p-6 overflow-y-auto max-h-[60vh] bg-gray-50">
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <InfoCard
                      title="Priority"
                      value={selectedReport.priority || "N/A"}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {selectedReport.equipmentTag && (
                          <div>
                            ...
                            <p className="text-gray-900 font-medium">{selectedReport.equipmentTag}</p>
                          </div>
                        )}
                        {selectedReport.serialNumber && (
                          <div>
                            <label className="text-sm font-medium text-gray-500">Serial Number</label>
                            <p className="text-gray-900 font-medium">{selectedReport.serialNumber}</p>
                          </div>
                        )}
