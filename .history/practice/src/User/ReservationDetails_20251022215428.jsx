...
function ReservationDetails({ reservation, setView, refreshReservations, user }) {
  ...
  const isParticipant = user && localReservation?.participants?.some(
    p => p.id_number === user.id_number || p.idNumber === user.id_number
  );
  ...
  const removeParticipant = async (participantId) => {
    ...
    await handleAction("remove-participant", { participantId });
  };
  ...
  return (
    <main className="ml-0 lg:ml-[250px] w-full lg:w-[calc(100%-250px)] flex flex-col min-h-screen bg-gray-50">
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {localReservation.participants.map((p, i) => {
                    const participantId = p.id_number || p.idNumber;
                    const isCurrentUser = user && participantId === user.id_number;
                    const canRemoveSelf = isCurrentUser && !isMainReserver;
                    const canRemoveAny = isMainReserver || isStaffOrAdmin;
                    ...
                    return (
                      <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-gray-50 hover:bg-gray-100"}>
                        ...
                        <td className="px-3 py-2 lg:px-4 lg:py-3 whitespace-nowrap text-xs lg:text-sm text-gray-900">
                          {p.name || "N/A"}
                          {isMainReserver && participantId === user?.id_number && (
                            <span className="ml-2 px-2 py-1 text-xs bg-blue-100 text-blue-800 rounded-full">Main Reserver</span>
                          )}
                        </td>
                        ...
                        <td className="px-3 py-2 lg:px-4 lg:py-3 whitespace-nowrap text-xs lg:text-sm text-gray-500">
                          {(canRemoveSelf || canRemoveAny) && (
                            <button
                              onClick={() => removeParticipant(participantId)}
                              disabled={removingParticipant === participantId}
                              className="text-red-600 hover:text-red-800 text-xs lg:text-sm font-medium cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                              {removingParticipant === participantId ? "Removing..." : "Remove"}
                            </button>
                          )}
                        </td>
                      </tr>
              ...
              <>
                ...
                {canRequestExtension && (
                  <button
                    ...
                    className="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">
              {isMainReserver ? "Cancel Reservation" : "Remove Yourself"}
            </h3>
            <p className="text-gray-600 mb-4">
              {isMainReserver 
                ? "Are you sure you want to cancel this reservation? This action cannot be undone and will remove all participants."
                : "Are you sure you want to remove yourself from this reservation? This action cannot be undone."}
            </p>
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                disabled={cancelling}
                className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {cancelling ? "Cancelling..." : (isMainReserver ? "Yes, Cancel" : "Yes, Remove")}
              </button>
            </div>
          </div>
        </div>
      ...
      {showStartConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-4">Are you sure you want to start this session?</p>
            <div className="flex justify-end space-x-3">
              <button
      ...
      {showEndEarlyConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-4">Are you sure you want to end this session early?</p>
            <div className="flex justify-end space-x-3">
              <button
              ...
              <button
                ...
                disabled={processingAction === "end-early"}
                className="bg-orange-600 text-white px-4 py-2 rounded-lg hover:bg-orange-700 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                disabled={processingAction === "approve"}
                className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
      ...
      {showExtendModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-4">
              You are about to request an extension for your ongoing session. 
              The system will automatically calculate the maximum possible extension time 
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                disabled={processingAction === "request-extension"}
                className="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
      ...
      {showResultModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Action Result</h3>
