      ...
      {showEndEarlyConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-4">Are you sure you want to end this session early? This will mark the reservation as completed.</p>
            <div className="flex justify-end space-x-3">
              <button
      ...
      {showStartConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-4">Are you sure you want to start this session? This will mark the reservation as ongoing.</p>
            <div className="flex justify-end space-x-3">
              <button
      ...
      {showExtendModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-4">Are you sure you want to request an extension for this ongoing session?</p>
            <div className="flex justify-end space-x-3">
              <button
              ...
              >
                {processingAction === "request-extension" ? "Requesting..." : "Yes, Request"}
              </button>
            </div>
          </div>
        </div>
