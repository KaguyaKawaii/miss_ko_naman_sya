...
function ReservationDetails({ reservation, setView, refreshReservations, user }) {
  ...
  const validateParticipantId = async (idNumber) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/reservations/validate-participant-id`, {
  ...
  const handleAddParticipant = async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/reservations/${localReservation._id}/add-participant`,
        {
          userId: user._id,
  ...
  const handleRemoveParticipant = async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/reservations/${localReservation._id}/remove-participant/${participantToRemove.id_number}`,
        {
          userId: user._id
        }
      );
