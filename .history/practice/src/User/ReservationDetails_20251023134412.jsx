...
const mongoose = require('mongoose'); // Make sure this is at the top of the file
...
function ReservationDetails({ reservation, setView, refreshReservations, user }) {
  ...
  const handleRemoveParticipant = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/api/reservations/${localReservation._id}/remove-participant/${participantToRemove.id_number}",
        {
          userId: user._id
        }
      );
