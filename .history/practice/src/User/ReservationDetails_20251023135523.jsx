...
const handleRemoveParticipant = async (participantId) => {
  ...
  try {
    // FIXED: Make sure this is using backticks, not quotes
    const response = await axios.delete(`http://localhost:5000/api/reservations/${reservationId}/participants/${participantId}`);
