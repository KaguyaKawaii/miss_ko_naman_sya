    ...
    <main className="ml-0 lg:ml-[250px] w-full lg:w-[calc(100%-250px)] flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="p-4 lg:p-6 space-y-6">
        ...
        {localReservation.participants && localReservation.participants.length > 0 && (
          <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6 border border-gray-100">
            <h2 className="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-100">
              Participants ({localReservation.participants.length}/4 max)
            </h2>
            ...
            {localReservation.participants.length >= 4 && (
              <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-700 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  Maximum of 4 participants reached. Cannot add more users.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 lg:gap-4 pt-4">
          ...
          {/* User Actions (if user owns this reservation) */}
          {!isStaffOrAdmin && reservationUserId === user?._id && (
            <>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                disabled={cancelling}
                className="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 disabled:opacity-50 transition-colors cursor-pointer"
              >
      ...
      {showEndEarlyConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <p className="text-gray-600 mb-6">Are you sure you want to end this reservation early? This action cannot be undone.</p>
            <div className="flex justify-end space-x-3">
              <button
              ...
              <button
                ...
                disabled={processingAction === "end-early"}
                className="px-4 py-2 bg-orange-600 text-white rounded hover:bg-orange-700 disabled:opacity-50 transition-colors cursor-pointer"
              >
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                disabled={processingAction === "start"}
                className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:opacity-50 transition-colors cursor-pointer"
              >
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <button
                ...
                disabled={processingAction === "approve"}
                className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 disabled:opacity-50 transition-colors cursor-pointer"
              >
      ...
      {showExtendModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <p className="text-gray-600 mb-4">You are requesting to extend your reservation time. The system will automatically find available time slots.</p>
            <div className="flex justify-end space-x-3 mt-6">
              ...
              <button
                ...
                disabled={processingAction === "request-extension"}
                className="px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 disabled:opacity-50 transition-colors cursor-pointer"
              >
                {processingAction === "request-extension" ? "Requesting..." : "Request Extension"}
              </button>
            </div>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="flex justify-end">
              <button
                ...
                className="px-4 py-2 bg-[#CC0000] text-white rounded hover:bg-red-700 transition-colors cursor-pointer"
              >
                OK
              </button>
            </div>
