...
function ReservationDetails({ reservation, setView, refreshReservations, user }) {
  ...
  // Get maximum participants based on room
  const getMaxParticipants = () => {
    if (!localReservation) return 0;
    
    const roomName = localReservation.roomName?.toLowerCase() || "";
    
    // Define maximum participants for each room type
    if (roomName.includes("room 1") || roomName.includes("room1")) return 4;
    if (roomName.includes("room 2") || roomName.includes("room2")) return 5;
    if (roomName.includes("room 3") || roomName.includes("room3")) return 6;
    if (roomName.includes("room 4") || roomName.includes("room4")) return 4;
    if (roomName.includes("room 5") || roomName.includes("room5")) return 5;
  ...
  const currentParticipants = localReservation?.participants?.length || 0;
  const canRemoveParticipants = isMainReserver || isStaffOrAdmin;
  ...
  return (
    <main className="ml-0 lg:ml-[250px] w-full lg:w-[calc(100%-250px)] flex flex-col min-h-screen bg-gray-50">
                      ...
                      {canRemoveParticipants && (
                        <td className="px-3 py-2 lg:px-4 lg:py-3 whitespace-nowrap text-xs lg:text-sm text-gray-900">
                          <button
                            ...
                            className="text-red-600 hover:text-red-900 font-medium text-xs lg:text-sm cursor-pointer"
                          >
                            Remove
                          </button>
                        </td>
      ...
      {showStartConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
            ...
            <p className="text-gray-600 mb-6">Are you ready to start your reservation now?</p>
            <div className="flex justify-end space-x-3">
              <button
              ...
              <button
                ...
                className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
                {processingAction === "start" ? "Starting..." : "Yes, Start Now"}
              </button>
            </div>
          </div>
        </div>
      ...
      {showEndEarlyConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
            ...
            <p className="text-gray-600 mb-6">Are you sure you want to end this reservation now?</p>
            <div className="flex justify-end space-x-3">
              <button
      ...
      {/* Approve Reservation Confirmation */}
      {showApproveConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Approve Reservation</h3>
            <p className="text-gray-600 mb-6">Are you sure you want to approve this reservation request?</p>
            <div className="flex justify-end space-x-3">
              <button
      ...
      {/* Reject Reservation Confirmation */}
      {showRejectConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Reject Reservation</h3>
            <p className="text-gray-600 mb-6">Are you sure you want to reject this reservation request?</p>
            <div className="flex justify-end space-x-3">
              <button
      ...
      {/* Approve Extension Confirmation */}
      {showApproveExtensionConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Approve Extension</h3>
            <p className="text-gray-600 mb-6">Are you sure you want to approve the extension request?</p>
            <div className="flex justify-end space-x-3">
              <button
      ...
      {/* Reject Extension Confirmation */}
      {showRejectExtensionConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Reject Extension</h3>
            <p className="text-gray-600 mb-6">Are you sure you want to reject the extension request?</p>
            <div className="flex justify-end space-x-3">
              <button
          ...
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
            ...
            <p className="text-gray-600 mb-6">
              ...
              <span className="font-semibold">
                {participantToRemove?.name || `${participantToRemove?.firstName || ""} ${participantToRemove?.lastName || ""}`.trim() || "this participant"}
              </span>{" "}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
            ...
            <p className="text-gray-600 mb-4">
              Your current reservation ends at {formatTimeOnly(currentEndTime)}. 
