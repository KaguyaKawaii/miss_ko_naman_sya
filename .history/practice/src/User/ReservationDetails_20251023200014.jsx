  ...
  const handleRemoveParticipant = async () => {
    ...
    try {
      const response = await axios.delete(
        `${import.meta.env.VITE_API_URL}/api/reservations/${localReservation._id}/participants/${participantToRemove._id || participantToRemove.id}`
      );
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                disabled={addingParticipant || !newParticipant.id_number || !newParticipant.name}
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mb-6">
              Are you sure you want to remove <strong>{participantToRemove.name || "this participant"}</strong> from the reservation? This action cannot be undone.
            </p>
            <div className="flex justify-end gap-3">
              <button
                onClick={() => {
