...
const getReservationUserId = () => {
  ...
  if (typeof localReservation.userId === 'string') {
    return localReservation.userId;
  }
  
  // If it's a populated user object, return the _id
  return localReservation.userId._id;
};

// Also add this helper function to get the main user's id_number for comparison
const getReservationUserInfo = () => {
  if (!localReservation) return null;
  
  if (typeof localReservation.userId === 'string') {
    return { _id: localReservation.userId, id_number: null };
  }
  
  return {
    _id: localReservation.userId?._id,
