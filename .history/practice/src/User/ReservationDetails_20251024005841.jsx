...
function ReservationDetails({ reservation, setView, refreshReservations, user }) {
  ...
  const fetchAvailableUsers = async (search = "") => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_URL}/api/reservations/participants/available-users`,
        {
          params: {
  ...
  const handleRemoveParticipant = async (participant) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/reservations/participants/remove`,
        {
          reservationId: localReservation._id,
  ...
  const handleAddParticipant = async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/reservations/participants/add`,
        {
          reservationId: localReservation._id,
