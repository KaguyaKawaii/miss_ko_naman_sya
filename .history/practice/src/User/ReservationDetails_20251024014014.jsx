...
function ReservationDetails({ reservation, setView, refreshReservations, user }) {
    ...
    if (value.length >= 2) {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/api/users/search?q=${encodeURIComponent(value)}`
        );
  ...
  const handleAddParticipant = async () => {
    ...
    setProcessingParticipantAction("add");
    try {
  ...
  const handleRemoveParticipant = async (participant) => {
    ...
    try {
      const response = await axios.delete(
        `${import.meta.env.VITE_API_URL}/api/reservations/${localReservation._id}/participants`,
        { data: { participantId: participant.id_number } }
      );
  ...
  const openRemoveConfirm = (participant) => {
    ...
    setActiveModal(MODAL_TYPES.REMOVE_PARTICIPANT);
  };

  const openAddParticipant = () => {
    setActiveModal(MODAL_TYPES.ADD_PARTICIPANT);
  };

  const openManageParticipants = () => {
    setActiveModal(MODAL_TYPES.MANAGE_PARTICIPANTS);
  };
  ...
  return (
    <main className="ml-0 lg:ml-[250px] w-full lg:w-[calc(100%-250px)] flex flex-col min-h-screen bg-gray-50">
        ...
        {localReservation.participants && localReservation.participants.length > 0 && (
          <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6 border border-gray-100">
            <div className="flex justify-between items-center mb-4 pb-2 border-b border-gray-100">
              <h2 className="text-lg font-semibold text-gray-800">Participants ({currentParticipantCount}/4)</h2>
              {isMainReserver && (
                <button
                  onClick={openManageParticipants}
                  className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors cursor-pointer flex items-center gap-2"
                >
      ...
      {activeModal === MODAL_TYPES.CANCEL_CONFIRM && (
      ...
      {activeModal === MODAL_TYPES.END_EARLY_CONFIRM && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200">
            <div className="flex items-center mb-4">
      ...
      {activeModal === MODAL_TYPES.START_CONFIRM && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200">
            <div className="flex items-center mb-4">
      ...
      {activeModal === MODAL_TYPES.APPROVE_CONFIRM && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200">
            <div className="flex items-center mb-4">
      ...
      {activeModal === MODAL_TYPES.REJECT_CONFIRM && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200">
            <div className="flex items-center mb-4">
              <div className="bg-red-100 p-2 rounded-full mr-3">
      ...
      {activeModal === MODAL_TYPES.APPROVE_EXTENSION_CONFIRM && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200">
            <div className="flex items-center mb-4">
              <div className="bg-green-100 p-2 rounded-full mr-3">
      ...
      {activeModal === MODAL_TYPES.REJECT_EXTENSION_CONFIRM && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200">
            <div className="flex items-center mb-4">
              <div className="bg-red-100 p-2 rounded-full mr-3">
      ...
      {/* Result Modal */}
      {activeModal === MODAL_TYPES.RESULT && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200">
            <div className="flex items-center mb-4">
              <div className="bg-blue-100 p-2 rounded-full mr-3">
      ...
      {/* Extend Modal */}
      {activeModal === MODAL_TYPES.EXTEND && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200">
            <div className="flex items-center mb-4">
      ...
      {activeModal === MODAL_TYPES.REMOVE_PARTICIPANT && participantToRemove && (
      ...
      {activeModal === MODAL_TYPES.ADD_PARTICIPANT && (
      ...
      {activeModal === MODAL_TYPES.MANAGE_PARTICIPANTS && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <button
                      onClick={() => setActiveModal(MODAL_TYPES.ADD_PARTICIPANT)}
