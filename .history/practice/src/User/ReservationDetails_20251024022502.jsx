...
function ReservationDetails({ reservation, setView, refreshReservations, user }) {
  ...
  const handleResultModalClose = () => {
    ...
    // Otherwise, stay on the current page (just close the modal)
  };
          ...
          {conflictInfo && conflictInfo.hasConflict && (
            <div className="mt-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
              <p className="text-sm text-orange-700 flex items-center">
                <svg xmlns="http://www3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
