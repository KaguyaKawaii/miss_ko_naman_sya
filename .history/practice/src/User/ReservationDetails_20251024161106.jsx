...
{showAddParticipantModal && (
  <div className="fixed inset-0 bg-black/40 backdrop-blur-md flex items-center justify-center z-[110] p-4 transition-all duration-300">
    <div className="bg-white rounded-3xl p-8 w-full max-w-md shadow-2xl border border-gray-100 transform transition-all duration-300 scale-100">
      {/* Header */}
      <div className="flex items-center mb-6 pb-4 border-b border-gray-100">
        <div className="bg-gradient-to-r from-green-400 to-emerald-500 p-3 rounded-2xl shadow-lg mr-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Search and select a user to add</p>
        </div>
      </div>
      ...
      <div className="space-y-6 mb-6">
        <div>
          ...
          <div className="relative">
            <input
              ...
              placeholder="Type name or ID number to search..."
              className="w-full p-4 pl-12 border-2 border-gray-200 rounded-2xl focus:ring-3 focus:ring-indigo-200 focus:border-indigo-500 transition-all duration-200 bg-gray-50 hover:bg-white"
            />
        ...
        {availableUsers.length > 0 && (
          <div className="max-h-60 overflow-y-auto border-2 border-gray-100 rounded-2xl shadow-inner">
            {availableUsers.map((user) => (
              <div
                key={user.id_number}
                className={`p-4 border-b border-gray-100 cursor-pointer transition-all duration-200 hover:scale-[1.02] hover:shadow-md ${
                  selectedUser?.id_number === user.id_number 
                    ? 'bg-gradient-to-r from-indigo-50 to-blue-50 border-l-4 border-l-indigo-400' 
                    : 'hover:bg-gray-50'
                }`}
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-sm font-medium text-gray-700">{user.course}</p>
                    <p className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-full">{user.department}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        {searchTerm.length >= 2 && availableUsers.length === 0 && (
          <div className="text-center py-8 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border-2 border-dashed border-gray-200">
        ...
        {selectedUser && (
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-5 shadow-sm">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">ID: {selectedUser.id_number}</p>
                </div>
              </div>
            ...
            <div className="mt-3 flex space-x-4 text-sm">
              <span className="bg-white px-3 py-1 rounded-full text-gray-700 border border-green-200">
                {selectedUser.course}
              </span>
              <span className="bg-white px-3 py-1 rounded-full text-gray-700 border border-green-200">
        ...
        {!canAddMoreParticipants && (
          <div className="bg-gradient-to-r from-orange-50 to-amber-50 border-2 border-orange-200 rounded-2xl p-5">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-semibold text-orange-800">Maximum Participants Reached</p>
                <p className="text-sm text-orange-700 mt-1">4 participants maximum. Remove someone first to add new participants.</p>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
        <button
          ...
          className="px-8 py-3 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-2xl transition-all duration-200 font-semibold border-2 border-gray-200 hover:border-gray-300 cursor-pointer"
        >
          Cancel
        </button>
        <button
