...
{showAddParticipantModal && (
  <div className="fixed inset-0 bg-black/40 backdrop-blur-md flex items-center justify-center z-[110] p-4 transition-all duration-300">
    <div className="bg-white rounded-3xl p-8 w-full max-w-4xl shadow-2xl border border-gray-100 transform transition-all duration-300 scale-100">
      {/* Header */}
      <div className="flex items-center justify-between mb-8 pb-6 border-b border-gray-100">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-lg text-gray-500 mt-2">Search for users and add them to your reservation</p>
          </div>
        </div>
        <div className="text-right">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-4 py-2 rounded-2xl border border-blue-200">
            ...
            <p className="text-2xl font-bold text-blue-700">{currentParticipantCount} <span className="text-lg text-blue-500">/ 4</span></p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 border-2 border-gray-100 shadow-sm">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Type name or ID number to search users..."
                className="w-full p-5 pl-14 text-lg border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-indigo-200 focus:border-indigo-500 transition-all duration-200 bg-white hover:bg-gray-50"
              />
            ...
            <p className="text-sm text-gray-500 mt-3 ml-1">Enter at least 2 characters to start searching</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border-2 border-gray-100 shadow-sm overflow-hidden">
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
              <h4 className="text-lg font-semibold text-gray-800 flex items-center">
                ...
                Available Users
                <span className="ml-2 bg-indigo-100 text-indigo-800 text-sm px-3 py-1 rounded-full">
                  {availableUsers.length} found
                </span>
              </h4>
            </div>
              ...
              {availableUsers.length > 0 ? (
                <div className="divide-y divide-gray-100">
                  {availableUsers.map((user) => (
                    <div
                      key={user.id_number}
                      className={`p-6 cursor-pointer transition-all duration-200 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-blue-50 group ${
                        selectedUser?.id_number === user.id_number 
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-lg text-gray-600 mt-1">ID: {user.id_number}</p>
                ...
                <div className="text-center py-16 bg-gradient-to-br from-gray-50 to-gray-100">
                  ...
                  <p className="text-gray-500 mt-2">Try searching with a different name or ID number</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          {selectedUser ? (
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border-2 border-green-200 shadow-lg">
              <div className="flex items-center justify-between mb-6">
                <h4 className="text-2xl font-bold text-gray-800 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 mr-3 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  Ready to Add
                </h4>
              ...
              <div className="bg-white rounded-2xl p-6 border border-green-200 shadow-sm">
                <div className="flex items-center space-x-5 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-600 mt-1">ID: {selectedUser.id_number}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                  <div className="bg-gray-50 p-4 rounded-2xl text-center">
                    ...
                    <p className="text-lg font-semibold text-gray-800 mt-1">{selectedUser.course}</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-2xl text-center">
                    <p className="text-sm text-gray-600 font-medium">Department</p>
                    <p className="text-lg font-semibold text-gray-800 mt-1">{selectedUser.department}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border-2 border-blue-200 text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-800 mb-2">No User Selected</h4>
              <p className="text-gray-600">Search and select a user from the list to add them as a participant</p>
            </div>
          )}

          {/* Maximum Participants Warning */}
          {!canAddMoreParticipants && (
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-6 border-2 border-orange-300">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-lg font-bold text-orange-800">Maximum Capacity Reached</p>
                  <p className="text-orange-700 mt-1">You have reached the maximum of 4 participants. Remove someone first to add new participants.</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
            <div className="flex justify-between items-center">
              <button
                ...
                className="px-8 py-4 text-lg text-gray-600 hover:text-gray-800 hover:bg-white rounded-2xl transition-all duration-200 font-semibold border-2 border-gray-300 hover:border-gray-400 cursor-pointer flex items-center"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                </svg>
