...
{showAddParticipantModal && (
  <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-[110] p-4 animate-fadeIn">
    <div className="bg-white rounded-xl w-full max-w-md shadow-2xl border border-gray-100 animate-scaleIn">
      ...
      <div className="px-6 pt-6 pb-4 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Search and select participants to add</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-5 space-y-5">
        ...
        {availableUsers.length > 0 && (
          <div className="space-y-2">
            ...
            <div className="max-h-48 overflow-y-auto border border-gray-200 rounded-lg shadow-sm">
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-600 mt-0.5">ID: {user.id_number}</p>
                    </div>
        ...
        {searchTerm.length >= 2 && availableUsers.length === 0 && (
          <div className="text-center py-6 border border-gray-200 rounded-lg bg-gray-50">
            ...
            <p className="text-sm text-gray-500 mt-0.5">Try adjusting your search terms</p>
          </div>
        )}
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-green-800">Selected Participant</p>
                <p className="font-medium text-gray-900">{selectedUser.name}</p>
                <p className="text-sm text-green-700">ID: {selectedUser.id_number} • {selectedUser.course}</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-orange-700 mt-0.5">4 participants maximum. Remove someone to add new participants.</p>
              </div>
            </div>
          </div>
        )}
