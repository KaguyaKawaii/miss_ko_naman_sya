...
{showAddParticipantModal && (
  <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-[110] p-4 animate-fadeIn">
    <div className="bg-white rounded-xl w-full max-w-2xl shadow-2xl border border-gray-100 animate-scaleIn">
      ...
      <div className="px-6 pt-6 pb-4 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Search and select participants to add to your event</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-5 space-y-5">
        ...
        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-700">
            Search by Name, ID Number, Course, or Department
          </label>
          <div className="relative">
            ...
            <input
              ...
              placeholder="Enter name, ID, course, or department..."
        ...
        {availableUsers.length > 0 && (
          <div className="space-y-3">
            <p className="text-sm font-medium text-gray-700">
              Found {availableUsers.length} participant{availableUsers.length !== 1 ? 's' : ''}
            </p>
        ...
        {searchTerm.length >= 2 && availableUsers.length === 0 && (
          <div className="text-center py-8 border border-gray-200 rounded-lg bg-gray-50">
            ...
            <p className="text-gray-600 font-medium text-lg">No participants found</p>
            <p className="text-sm text-gray-500 mt-1">Try searching with different keywords or check the spelling</p>
          </div>
        )}
        ...
        {selectedUser && (
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <p className="text-sm font-semibold text-green-800 uppercase tracking-wide">Selected Participant</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="space-y-1">
                ...
                <p className="text-gray-900 font-semibold">{selectedUser.id_number}</p>
              </div>
              <div className="space-y-1">
              ...
              {selectedUser.year_level && (
                <div className="space-y-1">
                  <p className="font-medium text-gray-700">Year Level</p>
                  <p className="text-gray-900">{selectedUser.year_level}</p>
                </div>
              )}
              {selectedUser.email && (
        ...
        {!canAddMoreParticipants && (
          <div className="bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-orange-800">Maximum Participants Reached</p>
                <p className="text-xs text-orange-700 mt-0.5">You've reached the maximum of 4 participants. Remove existing participants to add new ones.</p>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 rounded-b-xl">
        <div className="flex justify-between items-center">
          <div className="text-sm text-gray-500">
            {selectedUser ? `Ready to add ${selectedUser.name}` : 'Select a participant to continue'}
          </div>
          <div className="flex gap-3">
            <button
              ...
              className="px-5 py-2.5 text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-colors font-medium cursor-pointer"
            >
              Cancel
            </button>
            <button
              ...
              className="px-5 py-2.5 bg-gradient-to-br from-green-500 to-green-600 text-white rounded-lg hover:from-green-600 hover:to-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2 font-medium cursor-pointer shadow-sm hover:shadow-md"
            >
