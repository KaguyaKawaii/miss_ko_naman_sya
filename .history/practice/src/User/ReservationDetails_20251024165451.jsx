        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            <p className="text-sm font-medium text-blue-800">
              Current Participants: {currentParticipantCount} / 4
            </p>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded-full text-sm font-medium">
              {localReservation.participants.length} of 4
            </span>
          </div>
        ...
        <div className="space-y-4">
          ...
          {!canAddMoreParticipants ? (
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-orange-700 mt-1">
                    Remove a participant first to add a new one. Maximum of 4 participants allowed per reservation.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
              ...
              <p className="text-xs text-gray-400 mt-2">{4 - currentParticipantCount} spots available</p>
            </div>
          )}
        </div>
      </div>
