...
const reservationData = {
  ...
  numUsers: parseInt(formData.numUsers), // This should be additional participants only (3-7)
  purpose: formData.purpose,
  participants: formData.participants, // These are the additional participants
