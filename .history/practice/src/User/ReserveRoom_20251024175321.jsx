...
const check = await axios.get(`http://localhost:5000/api/reservations/check-limit/${user._id}`, {
    ...
    try {
      ...
      const additionalParticipants = formData.participants.filter(
  (participant, index) => index !== 0 // Remove the first participant (main reserver)
);
...
const reservationData = {
  ...
  participants: additionalParticipants, // Only additional participants (not including yourself)
