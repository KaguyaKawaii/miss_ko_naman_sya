        ...
        <div className="p-6 max-h-[70vh] overflow-y-auto">
          {availLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">There are no rooms to display for the selected date.</p>
            </div>
          ) : (
                        ...
                        return (
                          <div
                            ...
                            className={`p-5 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 transition-colors duration-150 ${
                              !isRoomActive ? "hover:bg-gray-50 bg-gray-50" : 
                          ...
                          >
                            ...
                            <div className="sm:text-right">
                              {!isRoomActive ? (
                                <span className="inline-block px-3 py-1.5 rounded-full text-xs font-semibold bg-gray-100 text-gray-600">
                                  Room Unavailable
                                </span>
                              ) : isOccupied ? (
