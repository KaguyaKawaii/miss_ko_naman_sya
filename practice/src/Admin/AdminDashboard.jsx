      ...
      {newsList.map((news) => (
        <li key={news._id} className="border border-gray-200 p-5 rounded-lg">
          ...
          <div className="grid grid-cols-3 gap-4 mt-4">
            <div onClick={() => setView("adminReservation")} className="cursor-pointer bg-red-100 hover:bg-gray-50 border border-gray-200 shadow rounded-2xl p-4 text-center transition">
              <h3 className="text-[#CC0000] font-semibold">Manage Reservations</h3>
            </div>
            <div onClick={() => setView("adminUsers")} className="cursor-pointer bg-red-100 hover:bg-gray-50 border border-gray-200 shadow rounded-2xl p-4 text-center transition">
              <h3 className="text-[#CC0000] font-semibold">Manage Users</h3>
            </div>
            <div onClick={() => setView("adminRoom")} className="cursor-pointer bg-red-100 hover:bg-gray-50 border border-gray-200 shadow rounded-2xl p-4 text-center transition">
              <h3 className="text-[#CC0000] font-semibold">Manage Rooms</h3>
            </div>
            <div onClick={() => setView("adminMessage")} className="cursor-pointer bg-red-100 hover:bg-gray-50 border border-gray-200 shadow rounded-2xl p-4 text-center transition">
              <h3 className="text-[#CC0000] font-semibold">View Messages</h3>
            </div>
            <div onClick={() => setShowNewsModal(true)} className="cursor-pointer bg-red-100 hover:bg-gray-50 border border-gray-200 shadow rounded-2xl p-4 text-center transition">
              <h3 className="text-[#CC0000] font-semibold">Post News</h3>
            </div>
            <div onClick={() => setView("adminReports")} className="cursor-pointer bg-red-100 hover:bg-gray-50 border border-gray-200 shadow rounded-2xl p-4 text-center transition">
