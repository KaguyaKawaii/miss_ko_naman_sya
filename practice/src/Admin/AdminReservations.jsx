      ...
      <main className="ml-[250px] w-[calc(100%-250px)] min-h-screen bg-gray-50">
        ...
        <header className="bg-white px-6 py-4 border-b border-gray-200">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-[#CC0000]">Reservation Management</h1>
              <p className="text-gray-600">View and manage all room reservations</p>
            </div>
        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-800">{roomName} @ {location}</p>
            </div>
            <div>
              <h3 className="text-sm font-medium text-gray-500">Reserved Date</h3>
              <p className="mt-1 text-gray-800">{formatPHDate(datetime)}</p>
            </div>
            <div>
              <h3 className="text-sm font-medium text-gray-500">Time</h3>
              <p className="mt-1 text-gray-800">{startTime} — {endTime}</p>
            </div>
            <div>
              <h3 className="text-sm font-medium text-gray-500">Number of Users</h3>
                ...
                <ul className="space-y-2">
                  {participants.map((p, idx) => (
                    <li key={idx} className="text-sm text-gray-800">
                      <span className="font-medium">{p.name}</span> — {p.courseYear}, {p.department} ({p.idNumber})
                    </li>
                  ))}
                </ul>
              </div>
