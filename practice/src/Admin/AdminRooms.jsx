        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-500">Available Floors</p>
                ...
                <div className="p-2 rounded-lg bg-purple-50 text-purple-600">
                  <MapPin size={20} />
                   ...
                   {/* Main Content - Reordered sections */}
          <div className="grid grid-cols-1 gap-6">
            {/* Recent Reservations moved to top */}
                  ...
                  {reservations.slice(0, 4).map((r) => (
                    <div key={r._id} className="border border-gray-200 rounded-lg p-3 hover:shadow-sm transition-shadow">
                      ...
                      <div className="mt-2 flex items-center text-xs text-gray-500">
                        ...
                        <span>{formatPHDateTime(r.datetime)}</span>
                      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div key={floor} className="relative group overflow-hidden rounded-lg h-32">
                      ...
                      <div className="absolute bottom-0 left-0 p-3">
                        ...
                        <p className="text-xs text-white/80">
                          {floor === "Ground Floor" ? "6 rooms" : 
                           floor === "2nd Floor" ? "8 rooms" :
                           floor === "4th Floor" ? "5 rooms" : "4 rooms"}
                        </p>
                      </div>
              ...
              {/* All Rooms Section - Now spans 2 columns */}
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {rooms.map((room) => (
                        <tr key={room._id} className="hover:bg-gray-50">
                          <td className="px-4 py-2 whitespace-nowrap font-medium text-sm">{room.roomName}</td>
                          <td className="px-4 py-2 whitespace-nowrap text-sm">{room.location}</td>
