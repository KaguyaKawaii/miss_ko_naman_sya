...
function Header({ onLoginClick, onSignUpClick }) {
  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 w-full z-50  shadow-lg backdrop-blur-lg">
        ...
        {/* Mobile Dropdown */}
        {isOpen && (
          <div className="md:hidden bg-[#B30000] border-t border-white/20 shadow-md px-6 py-4 flex flex-col gap-3">
            <button
              onClick={() => {
                onLoginClick();
                setIsOpen(false);
