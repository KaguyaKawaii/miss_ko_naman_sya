  ...
  const teamMembers = [
    {
      ...
      email: "",
      portfolio: "",
      joinDate: "di ko knows kung when ako nag start",
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-6xl max-h-[95vh] overflow-hidden border border-gray-200">
              ...
              <div className="flex flex-col lg:flex-row h-full">
                ...
                <div className="lg:w-2/5 bg-gradient-to-br from-red-50 to-red-50 p-8 border-r border-gray-200">
                  <div className="text-center h-full flex flex-col">
                    {/* Large Profile Picture */}
                    <div className="w-[10rem] h-[10rem] mx-auto mb-6 rounded-full bg-white p-3 shadow-lg border border-gray-200">
                      <img
                    ...
                    <div className="flex items-center justify-center gap-3 mb-4">
                      <activeMember.icon className="w-6 h-6 text-red-600" />
                      <span className="font-semibold text-red-600 text-xl">{activeMember.role}</span>
                    </div>
