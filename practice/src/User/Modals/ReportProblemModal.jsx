  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("http://localhost:5000/reports", {
        ...
        category,
        details,
        floor: showLocationFields ? floor : null,
        room: showLocationFields ? room : null,
      });
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#CC0000] focus:border-[#CC0000] outline-none transition-all"
            ...
            <div className="flex justify-end gap-3 pt-2">
              <button
                type="button"
                onClick={onClose}
                className="px-5 py-2.5 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-300 cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                className="px-5 py-2.5 text-white bg-[#CC0000] rounded-lg hover:bg-[#b10101] transition-all focus:outline-none focus:ring-2 focus:ring-[#CC0000] cursor-pointer disabled:opacity-70 flex items-center"
              >
                {isSubmitting ? (
                  <>
